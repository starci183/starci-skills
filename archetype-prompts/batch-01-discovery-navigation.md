...
- **Output boundary:** `archetypes/discovery/scrollytelling-chapter-explorer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/hierarchical-three-pane-explorer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/faceted-ranked-results/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/scoped-federated-search/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/map-results-explorer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/timeline-audit-explorer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/immersive-gallery-lightbox/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/media-rails-browser/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/editorial-feed-reader/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/hierarchical-content-browser/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/knowledge-graph-explorer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/parallel-document-reader/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/calendar-agenda-browser/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/comparison-matrix/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/manuscript-reader-notes/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/paged-presentation-stage/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/media-theater-queue/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/service-navigation-hub/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/spatial-route-itinerary-explorer/{en.md,vi.md,context.md,template.html}`.
