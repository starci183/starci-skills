...
- **Output boundary:** `archetypes/work/finite-element-mesh-convergence-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/sample-lineage-custody-explorer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/multichannel-microscopy-analysis-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/genomic-locus-read-evidence-inspector/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/phylogeny-alignment-comparison-explorer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/structure-spectrum-assignment-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/orthogonal-volume-slice-inspector/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/multichannel-waveform-analysis-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/experiment-randomization-design-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/systematic-evidence-synthesis-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/astronomical-observation-sequence-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/geospatial-raster-layer-analysis-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/spatial-change-detection-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/scientific-notebook-reproducibility-audit/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/microplate-dose-response-analysis-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/process-mass-balance-analyzer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/binary-structure-hex-inspector/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/query-plan-hotspot-analyzer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/heap-dominator-path-explorer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/sampled-call-stack-profile-explorer/{en.md,vi.md,context.md,template.html}`.
