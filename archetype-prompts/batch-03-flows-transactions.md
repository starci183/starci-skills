...
- **Output boundary:** `archetypes/flow/calculation-estimate-flow/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/single-question-step/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/linear-multi-step-application/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/nonlinear-task-list-application/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/repeated-item-manager/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/data-export-delivery-flow/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/data-import-mapping-pipeline/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/review-submit-ledger/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/guided-troubleshooting-tree/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/guided-setup-checklist/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/stage-gated-process-record/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/booking-slot-selection/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/spatial-seat-reservation/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/cart-checkout-flow/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/plan-selection-purchase/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/split-reference-form/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/consent-signature-ceremony/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/cross-party-handoff-flow/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/asynchronous-outcome-tracker/{en.md,vi.md,context.md,template.html}`.
...
- **Wide:** Milestone timeline + current expectation primary; requests/record/support rail supporting, unresolved request precedes routine history.
