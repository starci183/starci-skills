...
- **Output boundary:** `archetypes/work/clinical-differential-test-strategy-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/histopathology-slide-signout-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/longitudinal-radiology-comparison-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/dialysis-prescription-delivery-reconciliation/{en.md,vi.md,context.md,template.html}`.
...
- **Research anchors:** `WAI-STATUS`, `WAI-FOCUS`, `WAI-REFLOW`; add [CMS End-Stage Renal Disease facilities requirements](https://www.cms.gov/medicare/health-safety-standards/conditions-coverage-participation/end-stage-renal-disease-facilities) and [National Kidney Foundation KDOQI guidelines and commentaries](https://www.kidney.org/professionals/kdoqi/guidelines-and-commentaries).
...
- **Output boundary:** `archetypes/work/antimicrobial-susceptibility-interpretation-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/transfusion-compatibility-release-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/hereditary-variant-classification-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/pedigree-inheritance-risk-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/spirometry-maneuver-quality-repeatability-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/radiotherapy-contour-dose-plan-review/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/therapeutic-drug-monitoring-regimen-modeler/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/clinical-trial-safety-signal-triage/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/public-health-outbreak-hypothesis-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/exposure-contact-followup-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/infusion-titration-safety-console/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/implantable-cardiac-device-interrogation-programmer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/immunization-catch-up-series-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/cytogenetic-karyotype-assembly-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/cardiac-electrophysiology-ablation-map-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/haplotype-phase-block-curation-workbench/{en.md,vi.md,context.md,template.html}`.
