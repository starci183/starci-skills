...
- **Output boundary:** `archetypes/overview/live-operations-command-center/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/map-led-situation-monitor/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/dependency-topology-monitor/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/timeline-status-monitor/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/portfolio-health-matrix/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/goal-cascade-progress/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/capacity-allocation-overview/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/funnel-path-analysis/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/cohort-retention-grid/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/benchmark-comparison-overview/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/scenario-sensitivity-modeler/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/statistical-process-control-overview/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/risk-bow-tie-control-overview/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/distributed-trace-waterfall-monitor/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/authored-analytical-briefing/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/process-variant-mining-overview/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/risk-impact-likelihood-overview/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/market-depth-order-entry-monitor/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/bridge-contribution-waterfall-overview/{en.md,vi.md,context.md,template.html}`.
