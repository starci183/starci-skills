...
- **Output boundary:** `archetypes/work/air-traffic-separation-resolution-console/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/railway-movement-authority-control-console/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/rail-disruption-timetable-recovery-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/flight-procedure-obstacle-clearance-designer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/vessel-damage-stability-response-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/transit-network-service-pattern-authoring-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/search-and-rescue-coverage-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/ship-mooring-line-load-sharing-console/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/driver-duty-rest-compliance-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/aircraft-defect-deferral-disposition-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/passenger-disruption-reaccommodation-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/autonomous-vehicle-remote-assistance-console/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/aircraft-deicing-holdover-control-board/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/airspace-volume-deconfliction-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/rail-consist-inspection-release-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Wide:** Ordered consist, selected-car facts, brake coverage, defects/restrictions, dangerous-goods placement and global readiness/signoffs remain visible; only the consist strip owns bounded longitudinal overflow.
...
- **Output boundary:** `archetypes/overview/passenger-connection-protection-decision-board/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/transport-demand-assignment-modeling-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/rolling-stock-circulation-maintenance-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/aviation-crew-pairing-legality-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/navigation-lock-chamber-interlock-control-console/{en.md,vi.md,context.md,template.html}`.
