...
- **Output boundary:** `archetypes/work/storyboard-sequence-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/print-proof-preflight-review/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/chart-specification-authoring-studio/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/multi-rendition-creative-adaptation-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/overview/editorial-rundown-control-board/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/collective-bargaining-package-negotiation-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/moderated-briefing-qa-stage/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/collaborative-ideation-convergence-board/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/multi-program-eligibility-screening/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/shift-handoff-acknowledgement-board/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/care-transition-readiness-orchestrator/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/referral-negotiation-exchange/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/peer-instruction-revote-session/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/assessment-item-calibration-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/peer-review-exchange-cycle/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/learning-evidence-portfolio-composer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/discovery/prerequisite-pathway-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/flow/multi-item-return-resolution/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/odontogram-treatment-charting-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/sealed-bid-multi-lot-award-workbench/{en.md,vi.md,context.md,template.html}`.
