...
- **Output boundary:** `archetypes/detail/enterprise-record-home/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/editable-record-with-summary-rail/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/job-run-detail-timeline/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/order-fulfillment-tracker/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/evidence-led-case-resolution-dossier/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/bitemporal-record-validity-detail/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/settings/effective-setting-provenance-inspector/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/settings/independent-preference-autosave-center/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/settings/configuration-dependency-resolver/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/settings/constrained-quota-allocation-editor/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/support/support-handoff-redaction-review/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/settings/cross-scope-access-conflict-resolver/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/system/offline-draft-preservation-recovery/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/settings/credential-rotation-cutover-console/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/support/live-support-session-room/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/support/interactive-code-example-lab/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/support/diagnostic-evidence-bundle-review/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/work/multi-track-timeline-editor/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `archetypes/detail/causal-root-analysis-dossier/{en.md,vi.md,context.md,template.html}`.
