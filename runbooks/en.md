...
| Need | Runbook |
|---|---|
| Install tools, create encrypted records, sync, rotate or recover a credential | [Secrets](./secrets/en.md) |
| Start/stop the complete local platform or diagnose one backing service | [Local stack](./local-stack/en.md) |
| Configure Keycloak, Google login or GitHub login | [OAuth](./oauth/en.md) |
| Configure cAdvisor, Prometheus and Grafana Cloud remote write | [Observability](./observability/en.md) |
| Configure Husky, GitHub CI, Codecov Cloud and SonarQube Cloud | [Delivery assurance cloud](./delivery-assurance-cloud/en.md) |
| Configure payments, email, AI pools, remote S3, GCP or GitHub/data tokens | [External integrations](./external-integrations/en.md) |
