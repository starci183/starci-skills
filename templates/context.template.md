...
| --- | --- | --- | --- |
| `@<alias>/<params>` | `<location from alias/alias.json, code-spanned so placeholders render>` | how it is fingerprinted | Required or Optional · static or dynamic: purpose |
