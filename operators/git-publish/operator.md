...
the head this same publication pushed, and the session worktree, branch and folder are removed with
the runtime owner asked by name to stop the server it started.
