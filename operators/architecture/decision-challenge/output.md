...
| `payload.produced` | Session artifact `challengeReceiptRef` plus explicitly approved durable effects only. |
...
| --- | --- | --- | --- |
| `ready` | `completed` | `architecture.decision.handoff / ready` | architecture-challenge-ready |
