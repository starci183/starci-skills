...
const routes = {
  "ready": {
    "stage": "architecture.boundary.challenge",
    "status": "ready",
    "fact": "backend-boundary-ready",
    "state": "completed",
    "code": "architecture-boundary-plan-ready"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.boundaryPlanRef === null) errors.push('/payload/produced/boundaryPlanRef: successful output requires a session artifact');
