...
Classify contradictions in one architecture evidence set. Do not route subsequent work, persist task-session material, broaden the source boundary, or perform another operator's job.
