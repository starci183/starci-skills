...
**Stop:** Every component maps to a deployable; every physical store and read, write or migrate edge is qualified.

## Step 4 — Validate and emit

**Read:** candidate, evidence refs and lineage.  
**Context:** no new load. Validate against `migration/v6.1/architecture-backend/schemas/system-model.schema.json`.  
