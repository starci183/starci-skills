...
const routes = {
  "ready": {
    ...
    "status": "ready",
    "fact": "architecture-current-state-ready",
    "state": "completed",
    "code": "architecture-current-state-ready"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.currentStateRef === null) errors.push('/payload/produced/currentStateRef: successful output requires a session artifact');
