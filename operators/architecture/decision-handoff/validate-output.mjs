...
const routes = {
  "ready": {
    ...
    "status": "ready",
    "fact": "architecture-decision-ready",
    "state": "completed",
    "code": "architecture-decision-handoff-ready"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.planningContextRef === null) errors.push('/payload/produced/planningContextRef: successful output requires a session artifact');
