...
const routes = {
  "ready": {
    ...
    "status": "ready",
    "fact": "backend-source-ready",
    "state": "completed",
    "code": "architecture-source-discovery-ready"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.sourceReceiptRef === null) errors.push('/payload/produced/sourceReceiptRef: successful output requires a session artifact');
