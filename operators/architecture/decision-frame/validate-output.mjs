...
const routes = {
  "ready": {
    "stage": "architecture.decision.current",
    "status": "ready",
    "fact": "architecture-frame-ready",
    "state": "completed",
    "code": "architecture-decision-frame-ready"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.decisionFrameRef === null) errors.push('/payload/produced/decisionFrameRef: successful output requires a session artifact');
