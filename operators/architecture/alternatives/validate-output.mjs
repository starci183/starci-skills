...
const routes = {
  "ready": {
    "stage": "architecture.decision.challenge",
    "status": "ready",
    "fact": "architecture-options-ready",
    "state": "completed",
    "code": "architecture-alternatives-ready"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.optionSetRef === null) errors.push('/payload/produced/optionSetRef: successful output requires a session artifact');
