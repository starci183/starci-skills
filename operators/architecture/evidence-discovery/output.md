# `architecture/evidence-discovery` output

The output is an ephemeral typed artifact governed by `migration/v6.1/architecture-backend/schemas/evidence-claim-set.schema.json`.
...
Gate: Every claim carries kind, claim state, revision and evidence location; unknowns remain explicit.
