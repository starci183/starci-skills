...
const routes = {
  "ready": {
    ...
    "status": "ready",
    "fact": "backend-patterns-ready",
    "state": "completed",
    "code": "architecture-pattern-bind-ready"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.patternBindingRef === null) errors.push('/payload/produced/patternBindingRef: successful output requires a session artifact');
