...
function semantic(value) {
  ...
  if (p.decision === 'proved' && p.produced.tunnelReceiptRef === null) errors.push('$.payload.produced: proved output requires a receipt'); for (const mutation of p.produced.mutations) if (mutation.appliedBy !== 'coordinator') errors.push('$.payload.produced.mutations: coordinator ownership required');
