...
**Analysis:** materialize and verify approved local route bindings. Record evidence, criteria, and conclusions only; never record chain-of-thought.
...
**Action:** apply only this declared effect: write ignored machine-local route state.
