...
Verifies machine identity and its encrypted credential roster. Do not route later work, own workflow state, broaden source scope, or perform another operator's job.
