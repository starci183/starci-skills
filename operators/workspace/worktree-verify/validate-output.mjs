...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.worktreeReceiptRef === null) errors.push('/payload/produced/worktreeReceiptRef: successful output requires a session artifact');
