...
const routes = {
  "ready": {
    "stage": "workspace.routes.hydrate",
    "status": "ready",
    "fact": "workspace-declarations-ready",
    "state": "completed",
    "code": "workspace-declarations-compile-ready"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.compiledDeclarationsRef === null) errors.push('/payload/produced/compiledDeclarationsRef: successful output requires a session artifact');
