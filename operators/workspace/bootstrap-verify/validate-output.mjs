...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.bootstrapReceiptRef === null) errors.push('/payload/produced/bootstrapReceiptRef: successful output requires a session artifact');
