...
const routes = {
  "ready": {
    "stage": "workspace.declarations",
    "status": "ready",
    "fact": "workspace-bootstrap-ready",
    "state": "completed",
    "code": "workspace-bootstrap-verify-ready"
  },
  "initialize-required": {
    "stage": "workspace.initialization", "status": "ready", "fact": "workspace-bootstrap-initialize-required",
    "state": "replan", "code": "workspace-bootstrap-verify-initialize-required"
  },
  "blocked": {
    "stage": "workspace.blocked", "status": "blocked", "fact": "workspace-bootstrap-blocked",
    "state": "blocked", "code": "workspace-bootstrap-verify-blocked"
  }
};
...
function semantic(value) {
  ...
  if (value.payload.decision === 'ready' && value.payload.produced.bootstrapReceiptRef === null) errors.push('/payload/produced/bootstrapReceiptRef: ready output requires a session artifact');
  if (value.payload.decision !== 'ready' && value.payload.produced.bootstrapReceiptRef !== null) errors.push('/payload/produced/bootstrapReceiptRef: non-ready output cannot claim a readiness receipt');
