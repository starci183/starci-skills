...
const base = () => {
  const manifest = {
    ...
    semanticComposition: [
      { instanceRef: 'composition://intro', patternRef: 'pattern://ContextIntro', ownerRef: 'owner://intro', slots: [
      ...
      { instanceRef: 'composition://rail', patternRef: 'pattern://RightRail', ownerRef: 'owner://rail', slots: [{ slotRef: 'content', semanticRole: 'support', cardinality: 'many', order: 0 }] }],
