...
Collector luôn gửi và ghi `x-apollo-operation-name: StarCiRuntimeObservation` để GET chỉ đọc đáp ứng
kiểm tra operation header của server. Không nhận header do caller tự đặt; gate proof yêu cầu đúng
request intent không chứa secret này.
