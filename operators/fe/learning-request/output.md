...
| --- | --- | --- | --- |
| `recorded` | `completed` | `fe.maintenance.learning-request.result / complete` | `fe-learning-request-complete` |
| `blocked` | `blocked` | `fe.maintenance.blocked / blocked` | `fe-learning-request-blocked` |
