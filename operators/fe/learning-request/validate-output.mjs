...
const outcomes = {
  "recorded": {
    "key": "recorded",
    "stage": "fe.maintenance.learning-request.result",
    "status": "complete",
    "operatorStatus": "completed",
    "code": "fe-learning-request-recorded",
    "retryable": false,
    "factsAdd": [
      "fe-learning-request-complete"
    ],
    "factsRemove": []
  },
  "blocked": {
    ...
    "code": "fe-learning-request-blocked",
    "retryable": false,
    "factsAdd": [
      "fe-learning-request-blocked"
    ],
    "factsRemove": []
  }
};
const successfulDecisions = new Set(["recorded"]);
