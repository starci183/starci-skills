...
const outcomes = {
  "materialized": {
    ...
    "code": "fe-product-seed-materialized",
    "retryable": false,
    "factsAdd": [
      "seed-evidence"
    ],
...
const successfulDecisions = new Set(["materialized"]);
...
function semanticErrors(value) {
  ...
  if (success && produced.externalEffects.length === 0) errors.push('$.payload.produced.externalEffects: successful external decision requires a declared effect descriptor');
