...
const outcomes = {
  "resolved": {
    "key": "resolved",
    "stage": "fe.maintenance.learning-resolve.result",
    "status": "complete",
    "operatorStatus": "completed",
    "code": "fe-learning-resolve-resolved",
    "retryable": false,
    "factsAdd": [
      "fe-learning-resolve-complete"
    ],
    "factsRemove": []
  },
  "blocked": {
    ...
    "code": "fe-learning-resolve-blocked",
    "retryable": false,
    "factsAdd": [
      "fe-learning-resolve-blocked"
    ],
    "factsRemove": []
  }
};
const successfulDecisions = new Set(["resolved"]);
