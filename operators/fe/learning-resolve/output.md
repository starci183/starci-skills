...
| --- | --- | --- | --- |
| `resolved` | `completed` | `fe.maintenance.learning-resolve.result / complete` | `fe-learning-resolve-complete` |
| `blocked` | `blocked` | `fe.maintenance.blocked / blocked` | `fe-learning-resolve-blocked` |
