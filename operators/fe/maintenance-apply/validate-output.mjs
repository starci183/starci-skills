...
const outcomes = {
  "applied": {
    "key": "applied",
    "stage": "fe.maintenance.maintenance-apply.result",
    "status": "complete",
    "operatorStatus": "completed",
    "code": "fe-maintenance-apply-applied",
    "retryable": false,
    "factsAdd": [
      "fe-maintenance-apply-complete"
    ],
    "factsRemove": []
  },
  "blocked": {
    ...
    "code": "fe-maintenance-apply-blocked",
    "retryable": false,
    "factsAdd": [
      "fe-maintenance-apply-blocked"
    ],
    "factsRemove": []
  }
};
const successfulDecisions = new Set(["applied"]);
