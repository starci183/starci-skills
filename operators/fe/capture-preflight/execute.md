...
fixed round purpose, Grammar decision/audit, icon/media provenance, product-family benchmarks,
proof-matrix fingerprint, owner-partition
fingerprint, three viewports, and all 22 canonical probes. Evaluate the fourteen ordered readiness
checks: runtime origin, dependency graph, repository reproducibility, viewport controls,
...
`ready` requires all fourteen checks, registered preflight evidence, a fresh capture partition, and the
frozen settled populated happy-case hero at wide, intermediate, and compact with the core task and
major regions visible. Empty,
