...
const outcomes = {
  "reconciled": {
    "key": "reconciled",
    "stage": "fe.maintenance.block-reconcile.result",
    "status": "complete",
    "operatorStatus": "completed",
    "code": "fe-block-reconcile-reconciled",
    "retryable": false,
    "factsAdd": [
      "fe-block-reconcile-complete"
    ],
    "factsRemove": []
  },
  "blocked": {
    ...
    "code": "fe-block-reconcile-blocked",
    "retryable": false,
    "factsAdd": [
      "fe-block-reconcile-blocked"
    ],
    "factsRemove": []
  }
};
