...
| --- | --- | --- | --- |
| `reconciled` | `completed` | `fe.maintenance.block-reconcile.result / complete` | `fe-block-reconcile-complete` |
| `blocked` | `blocked` | `fe.maintenance.blocked / blocked` | `fe-block-reconcile-blocked` |
