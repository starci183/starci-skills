...
const outcomes = {
  ...
  "create-required": {
    ...
    "status": "ready",
    "operatorStatus": "completed",
    "code": "fe-source-fit-create-required",
    "retryable": false,
    "factsAdd": [
      "source-fit-ready",
      "create-required"
  ...
  "grammar-gap": {
    ...
    "status": "ready",
    "operatorStatus": "completed",
    "code": "fe-source-fit-grammar-gap",
    "retryable": false,
    "factsAdd": [
      "source-fit-ready",
      "grammar-gap"
...
const successfulDecisions = new Set(["reuse-only","create-required","grammar-gap"]);
