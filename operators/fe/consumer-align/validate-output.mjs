...
const outcomes = {
  "aligned": {
    "key": "aligned",
    "stage": "fe.maintenance.complete",
    "status": "complete",
    "operatorStatus": "completed",
    "code": "fe-consumer-align-aligned",
    "retryable": false,
    "factsAdd": [
      "fe-consumer-align-complete"
    ],
    "factsRemove": []
  },
  "blocked": {
    ...
    "code": "fe-consumer-align-blocked",
    "retryable": false,
    "factsAdd": [
      "fe-consumer-align-blocked"
    ],
    "factsRemove": []
  }
};
const successfulDecisions = new Set(["aligned"]);
