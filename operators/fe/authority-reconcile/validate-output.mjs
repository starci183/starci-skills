...
const outcomes = {
  "reconciled": {
    "key": "reconciled",
    "stage": "fe.maintenance.authority-reconcile.result",
    "status": "complete",
    "operatorStatus": "completed",
    "code": "fe-authority-reconcile-reconciled",
    "retryable": false,
    "factsAdd": [
      "fe-authority-reconcile-complete"
    ],
    "factsRemove": []
  },
  "blocked": {
    "key": "blocked",
    "stage": "fe.maintenance.blocked",
    "status": "blocked",
    "operatorStatus": "blocked",
    "code": "fe-authority-reconcile-blocked",
    "retryable": false,
    "factsAdd": [
      "fe-authority-reconcile-blocked"
    ],
    "factsRemove": []
  }
};
const successfulDecisions = new Set(["reconciled"]);
