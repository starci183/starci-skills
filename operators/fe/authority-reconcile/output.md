...
| --- | --- | --- | --- |
| `reconciled` | `completed` | `fe.maintenance.authority-reconcile.result / complete` | `fe-authority-reconcile-complete` |
| `blocked` | `blocked` | `fe.maintenance.blocked / blocked` | `fe-authority-reconcile-blocked` |
