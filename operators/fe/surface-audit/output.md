...
| --- | --- | --- | --- |
| `audited` | `completed` | `fe.maintenance.surface-audit.result / complete` | `fe-surface-audit-complete` |
| `blocked` | `blocked` | `fe.maintenance.blocked / blocked` | `fe-surface-audit-blocked` |
