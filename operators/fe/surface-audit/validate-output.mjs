...
const outcomes = {
  "audited": {
    "key": "audited",
    "stage": "fe.maintenance.surface-audit.result",
    "status": "complete",
    "operatorStatus": "completed",
    "code": "fe-surface-audit-audited",
    "retryable": false,
    "factsAdd": [
      "fe-surface-audit-complete"
    ],
    "factsRemove": []
  },
  "blocked": {
    ...
    "code": "fe-surface-audit-blocked",
    "retryable": false,
    "factsAdd": [
      "fe-surface-audit-blocked"
    ],
    "factsRemove": []
  }
};
const successfulDecisions = new Set(["audited"]);
