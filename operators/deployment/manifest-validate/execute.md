...
Validate one exact deployment manifest against pinned release intent. Do not route later work, own workflow state, broaden source scope, or perform another operator's job.
