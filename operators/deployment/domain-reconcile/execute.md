...
Reconciles declared domain and TLS state with the provider. Do not route later work, own workflow state, broaden source scope, or perform another operator's job.
