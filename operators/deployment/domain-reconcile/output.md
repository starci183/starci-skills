# `deployment/domain-reconcile` output
...
| `payload.produced` | Session `domainReceiptRef` and approved durable effects only. |
...
| --- | --- | --- | --- |
| `ready` | `completed` | `deployment.rollout / ready` | deployment-domain-ready |
