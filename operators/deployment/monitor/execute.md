...
Observe one rolling release and classify its current rollout condition. Do not route later work, own workflow state, broaden source scope, or perform another operator's job.
