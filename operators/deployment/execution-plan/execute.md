...
Compiles deployment intent and observed state into an executable plan. Do not route later work, own workflow state, broaden source scope, or perform another operator's job.
