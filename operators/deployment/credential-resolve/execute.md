...
Resolves opaque credential handles for the approved execution plan. Do not route later work, own workflow state, broaden source scope, or perform another operator's job.
