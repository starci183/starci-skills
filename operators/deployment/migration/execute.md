...
Produce one bounded migration result from exact supplied evidence. Do not route later work, own workflow state, broaden source scope, or perform another operator's job.
