# `deployment/host-prepare` output
...
| `payload.produced` | Session `hostReceiptRef` and approved durable effects only. |
...
| --- | --- | --- | --- |
| `ready` | `completed` | `deployment.artifact.build / ready` | deployment-host-ready |
