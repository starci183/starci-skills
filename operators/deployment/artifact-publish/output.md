# `deployment/artifact-publish` output
...
| `payload.produced` | Session `artifactPublishReceiptRef` and approved durable effects only. |
...
| --- | --- | --- | --- |
| `ready` | `completed` | `deployment.migration / ready` | deployment-artifacts-published |
