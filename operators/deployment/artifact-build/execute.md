...
Builds immutable release artifacts from pinned source revisions. Do not route later work, own workflow state, broaden source scope, or perform another operator's job.
