...
vào, ngân sách bước, tiền điều kiện tài khoản và fixture được khai báo, để những walker mù theo sau mỗi
...
sách bước, tiền điều kiện tài khoản và fixture được khai báo và tier của nó, và file `units` mang một đơn
...
| --- | --- | --- | --- | --- | --- |
| 1 | Kiểm gate và chạy lại | `resume`, `access`, `fixtures`, `sourceRoles` | `request/request.json`, bản kế hoạch bị chặn khi chạy lại | — | `INVALID_INPUT`, `NO_PROGRESS` |
...
| 6 | Cho mỗi luồng authenticated alias tài khoản riêng; cho mỗi luồng seeded namespace seed riêng; anonymous không có alias và fixtures=none không có namespace seed | `env` | các luồng, @worktrees/uat/<flow> cho các alias đã được cấp | — | — |
...
| case sheet đã đóng băng và hành trình frontend còn cần triển khai | `interface.generate` |
