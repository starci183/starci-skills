...
| 9 | Phát báo cáo, chặn với mọi bức tường được nêu khi có bức nào đứng | — | mọi thứ ở trên | `response/response.md`, `response/data/readiness-report.json`, `response/response.json` | `ENVIRONMENT_NOT_READY` |
