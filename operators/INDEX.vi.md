...
| `quality.verify` | `sonnet` | `@workspaces/<project>/<role>/gates`, `@workspaces/be`, `@workspaces/fe`, `@worktrees/debts` | `@dynamic/<receiptType>.json`, `@dynamic/gates/<gate>.json` | `@dynamic/gates/<gate>.json`, `@dynamic/gates/unit-coverage.coverage.json`, `@dynamic/quality-verification.json` | 8 | `INVALID_INPUT`, `SOURCE_DRIFT`, `PREDECESSOR_MIXED`, `PREDECESSOR_STALE`, `GATE_UNAVAILABLE`, `DEBT_UNAPPROVED`, `NO_PROGRESS` |
...
| --- | --- | --- |
| `@dynamic/<briefTargetRef>` | `content.generate` | `content.generate` |
| `@dynamic/<candidateId>.html` | `fe.direction.decide` | `fe.direction.decide` |
| `@dynamic/<decisionId>-alternatives.html` | `architecture.decide` | `architecture.decide` |
| `@dynamic/<imageTargetRef>` | `content.generate` | `content.generate` |
| `@dynamic/<language>.articleRef` | `content.generate` | `content.generate` |
| `@dynamic/<matrixId>.capture.json` | `fe.surface.audit` | `fe.surface.audit` |
| `@dynamic/<receiptType>.json` | — | `architecture.decide`, `backend.implement`, `business.decide`, `content.generate`, `fe.direction.decide`, `fe.presentation.resolve`, `fe.source.apply`, `fe.surface.audit`, `git.publish`, `quality.verify`, `release.deploy`, `workspace.bind` |
| `@dynamic/<reviewTargetRef>` | `content.generate` | — |
| `@dynamic/<target>.resolved.tsx` | `fe.presentation.resolve` | — |
| `@dynamic/<track>.sourceRef` | `content.generate` | `content.generate` |
| `@dynamic/architecture-decision.json` | `architecture.decide` | `architecture.decide`, `backend.implement`, `business.decide`, `fe.direction.decide` |
| `@dynamic/backend-implementation.json` | `backend.implement` | `backend.implement`, `fe.direction.decide` |
| `@dynamic/business-promise-authority.json` | `business.decide` | `fe.direction.decide` |
| `@dynamic/changes.md` | `backend.implement`, `fe.source.apply` | — |
| `@dynamic/conformance/<operationId>.<facet>.json` | `backend.implement` | — |
| `@dynamic/content-generation-receipt.json` | `content.generate` | `content.generate` |
| `@dynamic/coverage-matrix.json` | `business.decide` | `business.decide` |
| `@dynamic/current-state.json` | `architecture.decide` | `architecture.decide` |
| `@dynamic/fe-direction-decision.json` | `fe.direction.decide` | `fe.direction.decide`, `fe.presentation.resolve`, `fe.source.apply` |
...
| `@dynamic/gates/<gate>.json` | `quality.verify` | `quality.verify` |
| `@dynamic/gates/unit-coverage.coverage.json` | `quality.verify` | — |
| `@dynamic/git-publication.json` | `git.publish` | — |
| `@dynamic/independent-critique.json` | `architecture.decide` | `architecture.decide` |
...
| `@dynamic/stack-model.json` | `architecture.decide` | `architecture.decide` |
| `@dynamic/uat-flow-verification.json` | `uat.verify` | — |
| `@dynamic/workspace-route-binding.json` | `workspace.bind` | `git.publish`, `workspace.bind` |
