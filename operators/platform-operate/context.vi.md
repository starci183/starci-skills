...
| --- | --- | --- | --- |
| `@worktrees/sessions/central-runtime` | `<Source>/.worktrees/sessions/central-runtime/owner.json  (generation-<n>-ready.json and logs/ beside it)` | fingerprint + generation | Bắt buộc · tĩnh: The shared runtime owner: inventory, generation, health. |
| `@workspaces/ports/<project>` | `<Source>/.workspaces/ports/<project>.json` | fingerprint | Bắt buộc · tĩnh: Port projection the runtime binds to. |
...
| `@workspaces/projects/<project>/<role>` | `<Source>/.workspaces/projects/<project>/<role>.json` | fingerprint | Tuỳ chọn · tĩnh: Which projects the shared services serve. |
