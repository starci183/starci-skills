...
**Context:** load exact session refs plus `be.delivery-proof`; source, configuration, deployment and runtime evidence are observations, not authority.  
...
**Stop:** Semantic conformance passes before lint, tests and build; migration changes include rollback proof.
