...
Prove one backend delivery across interface, implementation, migration, runtime, and conformance evidence. Do not route subsequent work, persist task-session material, broaden the source boundary, or perform another operator's job.
