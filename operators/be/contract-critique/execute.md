...
Challenge one backend mutation contract against ownership and failure evidence. Do not route subsequent work, persist task-session material, broaden the source boundary, or perform another operator's job.
