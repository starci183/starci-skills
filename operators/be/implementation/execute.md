...
Apply one approved backend contract inside one frozen source boundary. Do not route subsequent work, persist task-session material, broaden the source boundary, or perform another operator's job.
