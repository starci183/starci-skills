...
await expectValid(reconciled({ 'response/data/model.json': modelDoc({ transition: 'implemented->implemented', previousState: 'implemented' }), 'response/response.md': responseMd({ transition: 'implemented->implemented', previousState: 'implemented' }) }), 'an implemented head reconciled again at a moved delivery');
