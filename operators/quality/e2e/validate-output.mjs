...
const routes = {
  "pass": {
    "stage": "quality.sonar",
    "status": "ready",
    "fact": "quality-e2e-pass",
    "state": "completed",
    "code": "quality-e2e-pass"
  },
  "in-boundary": {
    "stage": "be.repair",
    "status": "ready",
  ...
  "boundary-drift": {
    ...
    "state": "replan",
    "code": "quality-e2e-boundary-drift"
  },
  "external-blocker": {
    ...
    "state": "blocked",
    "code": "quality-e2e-external-blocker"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.e2eReceiptRef === null) errors.push('/payload/produced/e2eReceiptRef: non-blocked output requires a session artifact');
