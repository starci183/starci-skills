...
const routes = {
  "pass": {
    "stage": "quality.typecheck",
    "status": "ready",
    "fact": "quality-lint-pass",
    "state": "completed",
  ...
  "boundary-drift": {
    ...
    "state": "replan",
    "code": "quality-lint-boundary-drift"
  },
  "external-blocker": {
    ...
    "state": "blocked",
    "code": "quality-lint-external-blocker"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.lintReceiptRef === null) errors.push('/payload/produced/lintReceiptRef: non-blocked output requires a session artifact');
