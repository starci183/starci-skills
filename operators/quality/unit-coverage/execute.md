...
**Analysis:** execute the unit command, evaluate coverage, and classify failures. Record applied criteria, structured diagnostics, and conclusions only; never record chain-of-thought.
