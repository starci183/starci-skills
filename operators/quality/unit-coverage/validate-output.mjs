...
const routes = {
  "pass": {
    "stage": "quality.integration",
    "status": "ready",
    "fact": "quality-unit-coverage-pass",
    "state": "completed",
    "code": "quality-unit-coverage-pass"
  },
  "in-boundary": {
    "stage": "be.repair",
    "status": "ready",
    ...
    "state": "replan",
    "code": "quality-unit-coverage-in-boundary"
  },
  "boundary-drift": {
    ...
    "state": "replan",
    "code": "quality-unit-coverage-boundary-drift"
  },
  "external-blocker": {
    ...
    "state": "blocked",
    "code": "quality-unit-coverage-external-blocker"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.unitCoverageReceiptRef === null) errors.push('/payload/produced/unitCoverageReceiptRef: non-blocked output requires a session artifact');
