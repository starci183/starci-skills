...
const routes = {
  ...
  "in-boundary": {
    ...
    "state": "replan",
    "code": "quality-build-in-boundary"
  },
  "boundary-drift": {
    ...
    "state": "replan",
    "code": "quality-build-boundary-drift"
  },
  "external-blocker": {
    ...
    "state": "blocked",
    "code": "quality-build-external-blocker"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.buildReceiptRef === null) errors.push('/payload/produced/buildReceiptRef: non-blocked output requires a session artifact');
