...
Bind one implementation boundary to its exact templates, rules, and static-gate plan without running those gates. Do not route later work, own workflow state, broaden source scope, or perform another operator's job.
