...
const routes = {
  "pass": {
    ...
    "status": "ready",
    "fact": "quality-sonar-pass",
    "state": "completed",
    "code": "quality-sonar-pass"
  },
  "in-boundary": {
    "stage": "be.repair",
    "status": "ready",
    ...
    "state": "replan",
    "code": "quality-sonar-in-boundary"
  },
  "boundary-drift": {
    ...
    "state": "replan",
    "code": "quality-sonar-boundary-drift"
  },
  "external-blocker": {
    ...
    "state": "blocked",
    "code": "quality-sonar-external-blocker"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.sonarReceiptRef === null) errors.push('/payload/produced/sonarReceiptRef: non-blocked output requires a session artifact');
