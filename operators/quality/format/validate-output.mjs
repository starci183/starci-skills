...
const routes = {
  "pass": {
    "stage": "quality.lint",
    "status": "ready",
    "fact": "quality-format-pass",
    "state": "completed",
    "code": "quality-format-pass"
  },
  "in-boundary": {
    "stage": "be.repair",
    "status": "ready",
    ...
    "state": "replan",
    "code": "quality-format-in-boundary"
  },
  "boundary-drift": {
    ...
    "state": "replan",
    "code": "quality-format-boundary-drift"
  },
  "external-blocker": {
    ...
    "state": "blocked",
    "code": "quality-format-external-blocker"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.formatReceiptRef === null) errors.push('/payload/produced/formatReceiptRef: non-blocked output requires a session artifact');
