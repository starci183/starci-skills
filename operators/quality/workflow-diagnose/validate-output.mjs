...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.diagnosisReceiptRef === null) errors.push('/payload/produced/diagnosisReceiptRef: non-blocked output requires a session artifact');
