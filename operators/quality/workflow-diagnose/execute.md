...
Diagnoses one workflow invocation without changing it. Do not route later work, own workflow state, broaden source scope, or perform another operator's job.
