...
const routes = {
  ...
  "in-boundary": {
    ...
    "state": "replan",
    "code": "quality-integration-in-boundary"
  },
  "boundary-drift": {
    ...
    "state": "replan",
    "code": "quality-integration-boundary-drift"
  },
  "external-blocker": {
    ...
    "state": "blocked",
    "code": "quality-integration-external-blocker"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.integrationReceiptRef === null) errors.push('/payload/produced/integrationReceiptRef: non-blocked output requires a session artifact');
