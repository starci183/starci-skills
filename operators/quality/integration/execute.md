...
**Analysis:** execute integration tests and classify failures by ownership. Record applied criteria, structured diagnostics, and conclusions only; never record chain-of-thought.
