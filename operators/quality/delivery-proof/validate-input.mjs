...
const requiredFacts = ["quality-sonar-pass"];
const knowledgeIds = ["quality.source-gates"];
...
function semantic(value) {
  ...
  if (!/^\.worktrees\/[a-z0-9][a-z0-9-]*\/businesses(?:\/|$)/.test(value.payload.loads.business.authorityPath)) errors.push('/payload/loads/business: business authority must come from .worktrees/<project>/businesses');
