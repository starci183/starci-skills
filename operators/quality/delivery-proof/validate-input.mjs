...
function semantic(value) {
  ...
  if (!value.payload.loads.business.authorityPath.startsWith('.worktrees/business/')) errors.push('/payload/loads/business: business authority must come from .worktrees/business');
