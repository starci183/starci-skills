...
const routes = {
  "pass": {
    "stage": "delivery.proved",
    "status": "ready",
    "fact": "delivery-proof-ready",
    "state": "completed",
    "code": "quality-delivery-proof-pass"
  },
  "blocked": {
    "stage": "quality.blocked",
    "status": "blocked",
    "fact": "quality-proof-blocked",
    "state": "blocked",
    "code": "quality-delivery-proof-blocked"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.sourceDeliveryProofRef === null) errors.push('/payload/produced/sourceDeliveryProofRef: non-blocked output requires a session artifact');
