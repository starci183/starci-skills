...
const routes = {
  "implemented": {
    "stage": "business.complete",
    "status": "complete",
    "fact": "business-reconciled",
    "state": "completed",
    "code": "business-reconcile-implemented"
  },
  "discrepancy": {
    "stage": "business.blocked",
    "status": "blocked",
    "fact": "business-discrepancy",
    "state": "blocked",
    "code": "business-reconcile-discrepancy"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.reconciliationReceiptRef === null) errors.push('/payload/produced/reconciliationReceiptRef: successful output requires a session artifact');
