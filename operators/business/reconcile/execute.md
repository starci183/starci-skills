...
Compare one delivered evidence set with one published business feature head. Do not route subsequent work, persist task-session material, broaden the source boundary, or perform another operator's job.
