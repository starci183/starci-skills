...
const routes = {
  "ready": {
    ...
    "status": "ready",
    "fact": "business-evidence-ready",
    "state": "completed",
    "code": "business-evidence-normalize-ready"
  }
};
...
function semantic(value) {
  ...
  if (!blocked && value.payload.produced.evidencePackRef === null) errors.push('/payload/produced/evidencePackRef: successful output requires a session artifact');
