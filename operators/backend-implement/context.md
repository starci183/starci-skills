...
| `@receipt/architecture-decision/<invocationId>` | <@artifacts of the producing invocation>/<receipt file> | fingerprint + the sourceHead the receipt binds | Required: The frozen mutation contract the implementation fills and may not widen. |
...
| `@receipt/backend-implementation/<invocationId>` | <@artifacts of the producing invocation>/<receipt file> | fingerprint + the sourceHead the receipt binds | Optional: Prior implementation receipts; regression history. |
