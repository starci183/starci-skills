...
commit trên nhánh phiên mà `writes` ghi mọi đường dẫn đã khai với hash trước và sau, mọi giá trị đã
ghi có mặt trong inventory của resolution được bind, lượt quét trình bày trên write set đã chiếu
không thấy gì, và cây đọc lại tại commit bằng đúng cây đã resolve; hoặc, dưới mode dry, `writes`
mang kế hoạch với commit null và checkout không bị đụng tới.
