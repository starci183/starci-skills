...
-- added to the DDL without a version bump. migrateLedger backfills META_TABLE_DDL
-- standalone and installs EVENTS_DIGEST_TRIGGER if absent (ledger-db.mjs:341-361).
-- ============================================================================
