...
test("workflow parity accepts one owner per skill", () => {
    const result = checkWorkflows({
        ...
        contexts: [{ path: "workflows/x/context.md", text: "`skills/a/SKILL.md` `skills/b/SKILL.md`" }],
    })
...
test("workflow parity refuses duplicate and absent owners", () => {
    const result = checkWorkflows({
        physicalSkills: ["skills/a/SKILL.md", "skills/b/SKILL.md"],
        contexts: [
            { path: "workflows/x/context.md", text: "`skills/a/SKILL.md`" },
            { path: "workflows/y/context.md", text: "`skills/a/SKILL.md` `skills/c/SKILL.md`" },
        ],
    })
