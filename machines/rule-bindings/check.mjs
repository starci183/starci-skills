...
const roles = {
    be: {
        gateRouter: "gates/be/lints/context.md",
        gateRoot: "gates/be/lints",
        packageName: "@starci/eslint-canon-be",
    },
    fe: {
        gateRouter: "gates/fe/lints/context.md",
        gateRoot: "gates/fe/lints",
...
async function main(argv) {
    ...
    if (!selected) {
        console.error("Usage: node machines/rule-bindings/check.mjs (--be|--fe|--all)")
        return 2
    }
    let failed = false
