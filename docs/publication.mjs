...
//
// The site is generated, never hand-authored: `npm run sync` reads the records under `.claude-v3/`
...
//
//   source      path under .claude-v3/, and the route itself: `compilers/principles` publishes at
