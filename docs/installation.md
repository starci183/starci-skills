...
```sh
npx --yes --package=./starci-4.0.0-alpha.1.tgz starci init --dir /absolute/host
npx --yes --package=./starci-4.0.0-alpha.1.tgz starci doctor --dir /absolute/host --quick
```
...
```sh
npx --yes --package=./starci-4.0.0-alpha.1.tgz starci update --dir /absolute/host
npx --yes --package=./starci-4.0.0-alpha.1.tgz starci doctor --dir /absolute/host
```
