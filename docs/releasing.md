...
```sh
npx --yes --package=/absolute/release-output/starci-5.0.0-alpha.1.tgz starci --help
npx --yes --package=/absolute/release-output/starci-5.0.0-alpha.1.tgz starci init --dir /absolute/isolated-host
