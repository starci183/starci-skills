...
|---|---|---|---|
| `@mcp-qdrant` | `platform/mcp/qdrant/en.md` | en | provision or verify the local vector service and MCP runtime |
| `@mcp-embedding` | `platform/mcp/embedding/en.md` | en | inspect hardware, install Ollama and choose one dimension-locked embedding profile |
| `@mcp-source-context` | `platform/mcp/source-context/en.md` | en | index one or more verified workspace roles and generate client configuration |
| `@mcp-clients` | `platform/mcp/clients/en.md` | en | install the verified remote endpoint into both Codex/OpenAI and Claude Code |
