...
|---|---|---|
| [IFRS 9 Financial Instruments](https://www.ifrs.org/issued-runtime/standards/list-of-runtime/standards/ifrs-9-financial-instruments/) | Hedge-accounting policy, instrument recognition, and version context. | Does not prove product truth, exact geometry, breakpoints, components, or visual treatment. |
