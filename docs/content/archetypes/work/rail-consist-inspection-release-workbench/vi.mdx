...
- **Topology response:** Consist có thứ tự, dữ kiện toa đã chọn, brake coverage, defect/restriction, dangerous-goods placement và platform/readiness/signoff toàn cục cùng hiện diện; chỉ consist strip sở hữu overflow dọc đoàn.
