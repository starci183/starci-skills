...
|---|---|---|---|
| `@grammar` | `knowledge/grammars/tayson/grammar.json` | file | rule đóng cho public và CRM |
| `@facts` | `knowledge/grammars/tayson/facts.json` | file | catalog fact quan sát được |
| `@capsules` | `knowledge/grammars/tayson/capsules.json` | file | behavior bền vững cùng binding case/template |
| `@rulings` | `knowledge/grammars/tayson/rulings.json` | file | owner statement có negative boundary |
| `@master-system` | `knowledge/grammars/tayson/design-system.json` | file | một hệ thương hiệu Tây Sơn dùng cho public và CRM |
