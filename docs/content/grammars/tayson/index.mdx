---
title: Tây Sơn deterministic frontend grammar · English
---
...
|---|---|---|---|
| `@grammar` | `knowledge/grammars/tayson/grammar.json` | file | closed public and CRM fact-to-outcome rules |
| `@facts` | `knowledge/grammars/tayson/facts.json` | file | closed observable fact catalog |
| `@capsules` | `knowledge/grammars/tayson/capsules.json` | file | durable behavior and case/template bindings |
| `@rulings` | `knowledge/grammars/tayson/rulings.json` | file | owner statements with negative boundaries |
| `@master-system` | `knowledge/grammars/tayson/design-system.json` | file | one Tây Sơn brand system shared by public and CRM surfaces |
