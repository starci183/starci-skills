...
|---|---|---|---|
| `@grammar` | `knowledge/grammars/starci/grammar.json` | file | closed fact-to-outcome rules |
| `@facts` | `knowledge/grammars/starci/facts.json` | file | closed observable fact catalog |
| `@capsules` | `knowledge/grammars/starci/capsules.json` | file | durable behavior, rulings and case/template bindings |
| `@rulings` | `knowledge/grammars/starci/rulings.json` | file | normalized owner statements, scope and negative boundaries |
| `@master-system` | `knowledge/grammars/starci/design-system.json` | file | one compact visual system shared before page-level deviations |
