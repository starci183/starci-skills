...
| `@workspaces` | `knowledge/contexts/workspaces/vi.md` | vi | resolve và xác minh mọi project/role được yêu cầu |
| `@mcp` | `platform/mcp/vi.md` | vi | contract Qdrant, index và publication toàn Source |
| `@embedding` | `platform/mcp/embedding/vi.md` | vi | cài Ollama và chọn model theo phần cứng |
| `@clients` | `platform/mcp/clients/vi.md` | vi | cài client Codex/OpenAI và Claude Code |
