 ...
 * to. `canon/fe/enforce/spacing/overview.md` is the one a person reads before writing a component, and it is
...
if (!existsSync(CANON)) {
    ...
    console.log("Write canon/fe/enforce/spacing/overview.md, or point this gate at a root that has one.");
    process.exit(1);
}
