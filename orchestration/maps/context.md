...
|---|---|---|
| Frontend design | Layout, Block and Layout Refactor | `orchestration/frontend/context.md` |
| Capability pipelines | Every other StarCi capability | `orchestration/capabilities/context.md` |
