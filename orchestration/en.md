...
This module currently binds `starci-fe-design-layout`, `starci-fe-design-block` and
`starci-fe-layout-refactor`. Other skills remain sequential until they explicitly load this authority and publish a
validated phase map.
