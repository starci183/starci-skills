...
| `@frontend-quality` | `brainstorms/frontend-quality/vi.md` | vi | bind integrated frontend review và advisory-source boundary |
...
| `page-synthesis` | author page map, journey direction, business obligation, merge binding, UI direction, candidate anatomy cùng schema-9 `pageContract`; sở hữu mười lens decision, character signature và eligibility; recommend candidate | chạy isolated top-down/capability audit; thu bounded quality evidence cùng sáu detector-family result; chỉ sau coordinator freeze eligible JSON mới sinh complete HTML/interaction/capture | direction receipt, quality review, synthesis matrix, pages artifact, preview HTML và maturity evidence | independent receipt pass trước join; binding thắng advisory; HTML project frozen eligible JSON; Sol/Opus trình `OK #1` |
...
| `direction` | liệt kê state thật; chọn part; author direction; sở hữu mọi quality lens decision và eligibility; freeze schema-3 anatomy | audit precedent/feasibility, thu detector evidence; sau eligible anatomy freeze mới sinh complete-parent HTML/capture | schema-3 block anatomy, quality review, audit verdict và direction review | phủ mọi reachable state cùng BLOCK-1…15; binding thắng advisory; Sol/Opus trình `OK #1` |
