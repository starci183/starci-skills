...
const SEQUENCE_STEPS={
  ...
  'owner.ask':v=>({
    steps:[
      ...
      `Then ASK IN THIS TERMINAL, before you report: print the question and the options numbered exactly as they stand in the record, and print "the owner may answer here with the number, or later with workflow-answer --op <this op> --choice <n>". Wait for the answer as long as your contract lets you wait, and then report.`,
