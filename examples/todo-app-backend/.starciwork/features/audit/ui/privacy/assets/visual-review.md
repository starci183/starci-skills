# Visual review: ui.audit.privacy / ADDENDUM 2
...
Before: Custom danger outline and black secondary ink differed from actual Button variants.

Corrected: Actual blue-label secondary Export and neutral-outline Request erasure; two app-owned content groups inside the real SurfaceCard boundary.
...
Selected PNG: assets/privacy-erasure-refused.png (1536 x 1024), SHA256 412f3509eb05d32f1f7f312a61959d59b4200448e4d6d0910ad7b2674f86de1c. Exact prompt: assets/privacy-erasure-refused.prompt.txt, SHA256 a29af848aac14496611790c7172c0033ef2b69692074ae184f05c3271032a6d0. Tool: image_gen.imagegen; no model field exposed. One generation from the actual reference images produced this direction.
