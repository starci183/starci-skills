    ...
    try {
      for (const [state, tasks] of Object.entries(FIXTURES)) {
        for (const [viewportName, viewport] of Object.entries(VIEWPORTS)) {
          /* dsf 2 renders the page the way current retina-class displays paint it: the same CSS
           * layout, with shape edges rasterized at twice the density so brand-colour fills dominate
           * their antialiased fringes the way they do on real hardware. */
