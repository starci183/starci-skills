# Visual review: ui.plan.usage / ADDENDUM 2
...
Before: Black Upgrade label and a Progress anatomy claim without a real render in the new set.

Corrected: White primary label; preserved 40/20 and 200% over-cap state composed using Text, with no uncaptured progress control.
...
The record declares layout, native task/choice controls, breadcrumb/account content and applicable empty/occurrence groups as application-owned regions. The 40/20 and 200% facts remain visible as Text; no unreferenced Progress appearance is invented. Business inputs and all 8 state/screen/viewport entries remain bound. Mobile is a derived specification, not a captured screen.
...
Selected PNG: assets/usage-over-cap-frozen.png (1536 x 1024), SHA256 a9296caefaa483674b3af87cc096ccaaa87369a0b577db2fef1884de98c578b9. Exact prompt: assets/usage-over-cap-frozen.prompt.txt, SHA256 86bda549cf92152b0e9f0bc65f052fcc836cb86f22925323b8cfd37ef691a4d4. Tool: image_gen.imagegen; no model field exposed. One generation from the actual reference images produced this direction.
