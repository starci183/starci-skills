...
import { ConfigurableModuleClass, OPTIONS_TYPE } from './notify-queue.module-definition';
import { NotifyQueueClient } from './notify-queue.client';
...
export class NotifyQueueModule extends ConfigurableModuleClass {
  static register(options: typeof OPTIONS_TYPE = {}): DynamicModule {
    ...
    return {
      ...base,
      providers: [...(base.providers ?? []), { provide: NotifyQueuePort, useClass: NotifyQueueClient }],
