...
export class PaymentIntentEntity {
  ...
  @Column('text', { name: 'subscription_id' })
  subscriptionId!: string;

  @Column('text', { default: 'sepay' })
  gateway!: string;

  @Column('text', { name: 'gateway_intent_id' })
  gatewayIntentId!: string;

  @Column('integer')
  amount!: number;

  @Column('text', { default: 'VND' })
  currency!: string;

  @Column('text', { default: 'pending' })
  status!: string;

  @Column('timestamptz', { name: 'applied_at', nullable: true })
  appliedAt!: Date | null;
}
