...
describe('calendar.util (br.recur.impossible-date.skips, sds.recur.generation-engine)', () => {
  ...
  it('every-weekday never includes a Saturday or Sunday', () => {
    const dates = datesForRule({ frequency: 'every-weekday', n: null, dayOfMonth: null, startDate: '2026-09-14' }, '2026-09-14', '2026-09-20');
  ...
  it('every-n-days fires every n days starting from the rule\'s own startDate', () => {
    const dates = datesForRule({ frequency: 'every-n-days', n: 3, dayOfMonth: null, startDate: '2026-01-01' }, '2026-01-01', '2026-01-10');
  ...
  it('never produces a date before the rule\'s own startDate even when asked for an earlier range', () => {
    const dates = datesForRule({ frequency: 'every-weekday', n: null, dayOfMonth: null, startDate: '2026-09-16' }, '2026-09-01', '2026-09-18');
  ...
  it('monthly-day-31 never substitutes the last day of a shorter month (clamp is rejected, per decision.recur.impossible-date)', () => {
    const dates = datesForRule({ frequency: 'monthly-day', n: null, dayOfMonth: 31, startDate: '2026-04-01' }, '2026-04-01', '2026-04-30');
