...
| --- | --- | --- | --- |
| Landing home · `:3069/` | [Image](features/checkout/ui/landing-home/assets/landing-home.png) | [Prompt](features/checkout/ui/landing-home/assets/landing-home.prompt.txt) | [Record](features/checkout/ui/landing-home/index.yaml) |
| Shop browse · `:4069/browse` | [Image](features/checkout/ui/shop-browse/assets/shop-browse.png) | [Prompt](features/checkout/ui/shop-browse/assets/shop-browse.prompt.txt) | [Record](features/checkout/ui/shop-browse/index.yaml) |
| Populated cart · `:4069/cart` | [Image](features/checkout/ui/cart/assets/cart.png) | [Prompt](features/checkout/ui/cart/assets/cart.prompt.txt) | [Record](features/checkout/ui/cart/index.yaml) |
| Account / sign-in · `:4069/account` | [Image](features/identity/ui/sign-in/assets/sign-in.png) | [Prompt](features/identity/ui/sign-in/assets/sign-in.prompt.txt) | [Record](features/identity/ui/sign-in/index.yaml) |
| Stock refusal · `:4069/checkout` | [Image](features/checkout/ui/stock-refused/assets/stock-refused.png) | [Prompt](features/checkout/ui/stock-refused/assets/stock-refused.prompt.txt) | [Record](features/checkout/ui/stock-refused/index.yaml) |
...
The [retained B3 source](features/checkout/ui/landing-home/assets/B3-source.txt) was found
...
[Artifact verification](features/checkout/ui/landing-home/assets/direction-check.yaml)
