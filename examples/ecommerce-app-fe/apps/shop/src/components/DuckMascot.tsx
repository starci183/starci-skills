 ...
 * and empty surfaces only, and error/refusal renders never receive it. This copy is the shop
 * app's port of the mark; the landing app carries the same drawing (one authored mark, per-app ports,
 * like the per-app projection readers). The direction a generated successor is drawn from lives at
 * `brand/duck.prompt.txt`; until one exists the inline SVG is the shipped mark - real artwork, not
 * a fabricated remote image URL.
 *
