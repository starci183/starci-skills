...
export type AppProvidersProps = {
    ...
    /**
     * The shop origin resolved once on the server - the client tree cannot read the port
     * projection, so the value crosses the server/client boundary here, beside the messages.
     */
...
/** Mount the copy, vendor-locale, theme and shop-origin contexts around the routed tree. */
        ...
        <I18nProvider locale={props.locale}>
            <ThemeProvider>
                <FeKitI18nProvider locales={i18n.LOCALES} navigation={FE_KIT_NAVIGATION}>
                    <ShopUrlProvider shopUrl={props.shopUrl}>{props.children}</ShopUrlProvider>
                </FeKitI18nProvider>
            </ThemeProvider>
        </I18nProvider>
    </NextIntlClientProvider>
