 ...
 * and empty surfaces only, and error/refusal renders never receive it. This copy is the landing
 * app's port of the mark; the shop app carries the same drawing (one authored mark, per-app ports,
