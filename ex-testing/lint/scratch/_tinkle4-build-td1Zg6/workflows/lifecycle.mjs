...
import {isAuditOperation} from '../kernel/audit.mjs';
...
function workBindings(run,cell){
 ...
 const checked=validateWorkspace(run.workRoot),recovering=investigationOps.has(cell.op),measuring=isAuditOperation({kind:cell.op,operation:cell.operation});
