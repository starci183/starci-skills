 ...
 */
@Entity({
    name: "audit_log_lines" 
})
/** TypeORM entity mapped to the audit log line row on the primary database; services reach it through the entity manager, not a repository. */
