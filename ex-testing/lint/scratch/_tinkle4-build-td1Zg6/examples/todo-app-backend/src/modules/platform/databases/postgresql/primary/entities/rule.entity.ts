...
/** TypeORM entity mapped to the rule row on the primary database; services reach it through the entity manager, not a repository. */
export class RuleEntity {
  ...
  @Column("integer",
      {
          name: "day_of_month", nullable: true 
      })
