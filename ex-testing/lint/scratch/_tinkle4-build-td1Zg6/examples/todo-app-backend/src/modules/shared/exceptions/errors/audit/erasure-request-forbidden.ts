...
/** Type alias naming the erasure request forbidden exception metadata set erasure-request-forbidden switches on; a new member is added here once, not scattered as literals. */
...
export class ErasureRequestForbiddenException extends AbstractException {
    constructor(metadata: ErasureRequestForbiddenExceptionMetadata = {
        ...
        super("This erasure request does not belong to the caller.",
            "ERASURE_REQUEST_FORBIDDEN_EXCEPTION",
            metadata)
    }
}
