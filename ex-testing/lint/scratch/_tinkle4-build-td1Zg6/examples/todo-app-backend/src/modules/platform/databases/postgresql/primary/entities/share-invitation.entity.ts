...
/** TypeORM entity mapped to the share invitation row on the primary database; services reach it through the entity manager, not a repository. */
export class ShareInvitationEntity {
  ...
  @Column("timestamptz",
      {
          name: "accepted_at", nullable: true 
      })
