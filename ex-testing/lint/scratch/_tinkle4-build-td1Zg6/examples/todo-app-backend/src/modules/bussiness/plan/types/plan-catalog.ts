...
export const FREE_PLAN: PlanDefinition = {
    id: "free", tier: "free", taskCap: FREE_PLAN_TASK_CAP 
}
export const PAID_PLAN: PlanDefinition = {
    id: "paid", tier: "paid" 
}

export const PLAN_CATALOG: ReadonlyArray<PlanDefinition> = [FREE_PLAN,
    PAID_PLAN]

/** Find plan by id for the plan-catalog flow - one named step of the types capability's behaviour. */
