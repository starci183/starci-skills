...
/** TypeORM entity mapped to the subscription row on the primary database; services reach it through the entity manager, not a repository. */
export class SubscriptionEntity {
  ...
  @Column("timestamptz",
      {
          name: "period_end", nullable: true 
      })
      periodEnd!: Date | null

  @Column("text",
      {
          name: "gateway_customer_id", nullable: true 
      })
