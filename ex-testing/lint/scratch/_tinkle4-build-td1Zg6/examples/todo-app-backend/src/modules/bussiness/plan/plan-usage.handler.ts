...
import {
    PlanUsageQuery, PlanUsageQueryResult 
...
export class PlanUsageHandler extends AbstractQueryHandler<PlanUsageQuery, PlanUsageQueryResult> {
    constructor(
    ...
    protected override async process(query: PlanUsageQuery): Promise<PlanUsageQueryResult> {
        ...
        return {
            plan: plan.id, cap: plan.taskCap ?? null, activeCount 
        }
    }
}
