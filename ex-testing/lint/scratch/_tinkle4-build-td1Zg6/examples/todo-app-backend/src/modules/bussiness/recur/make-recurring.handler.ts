...
import {
    MakeRecurringCommand, MakeRecurringCommandResult 
...
export class MakeRecurringHandler extends AbstractCommandHandler<MakeRecurringCommand, MakeRecurringCommandResult> {
    constructor(
    ...
    protected override async process(command: MakeRecurringCommand): Promise<MakeRecurringCommandResult> {
