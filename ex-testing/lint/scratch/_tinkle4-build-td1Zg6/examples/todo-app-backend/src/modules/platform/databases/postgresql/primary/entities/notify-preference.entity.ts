...
/** TypeORM entity mapped to the notify preference row on the primary database; services reach it through the entity manager, not a repository. */
export class NotifyPreferenceEntity {
  ...
  @Column("integer",
      {
          name: "digest_window_minutes", nullable: true 
      })
