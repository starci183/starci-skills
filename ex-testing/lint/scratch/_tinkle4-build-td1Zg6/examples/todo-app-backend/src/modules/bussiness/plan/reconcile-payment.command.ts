/** Contract naming the reconcile payment command params shape bussiness/plan code and its consumers share; a second site never retypes it inline. */
...
/** Contract naming the reconcile payment command result shape bussiness/plan code and its consumers share; a second site never retypes it inline. */
