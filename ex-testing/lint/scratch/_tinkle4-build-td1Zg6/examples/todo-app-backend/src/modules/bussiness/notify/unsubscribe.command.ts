/** Contract naming the unsubscribe command params shape bussiness/notify code and its consumers share; a second site never retypes it inline. */
export interface UnsubscribeCommandParams {
  readonly actorId: string;
  readonly channel: string;
}

/** Contract naming the unsubscribe command result shape bussiness/notify code and its consumers share; a second site never retypes it inline. */
