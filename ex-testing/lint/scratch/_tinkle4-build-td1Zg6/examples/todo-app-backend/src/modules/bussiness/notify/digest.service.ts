...
/** Contract naming the admit into window result shape bussiness/notify code and its consumers share; a second site never retypes it inline. */
...
/** Contract naming the flushed window shape bussiness/notify code and its consumers share; a second site never retypes it inline. */
