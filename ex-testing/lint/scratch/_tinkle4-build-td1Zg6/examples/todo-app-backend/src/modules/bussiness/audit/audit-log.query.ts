...
/** Contract naming the audit log query params shape bussiness/audit code and its consumers share; a second site never retypes it inline. */
...
export const assertReadableActor = (params: AuditLogQueryParams): void => {
    if (!params.personId) {
        throw new AuditOperatorRoleNotAuthorizedException({
            actor: "<missing>" 
        })
    }
}

/** Contract naming the audit log line summary result shape bussiness/audit code and its consumers share; a second site never retypes it inline. */
...
/** Contract naming the audit log query result shape bussiness/audit code and its consumers share; a second site never retypes it inline. */
export interface AuditLogQueryResult {
  readonly lines: Array<AuditLogLineSummaryResult>;
}
