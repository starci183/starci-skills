 ...
 */
@Controller("health")
/** GET /health - the api's one anonymous door: answers ok only when the primary postgres dependency answers, so an orchestrator's probe sees a real readiness signal. */
