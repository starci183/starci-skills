...
/** Every word the pure task list renders, resolved by the connected half. The two formatters carry
 * the numbers only the view knows - the row tally and the title of the row under confirmation. */
export type TaskListViewCopy = {
 ...
 * and every word it draws arrives resolved through `copy`. */
                                ...
                                <>
                                    ...
                                    {taskCount > 0 ? (
                                        <Text as="span" size="sm" tone="muted">
                                            {copy.formatTaskCount(taskCount)}
                                        </Text>
                                    ) : null}
                                </>
                            }
