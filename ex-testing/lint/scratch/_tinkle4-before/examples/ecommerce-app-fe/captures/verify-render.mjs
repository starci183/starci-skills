 ...
 * captures have no gate-side proof path, and `checks/render.mjs` has to be called directly — the same thing
...
if (args.mode === 'custody') {
  ...
  if (!brandDoc?.brand || typeof brandDoc.brand !== 'object' || Array.isArray(brandDoc.brand)) {
    say('fail', 'RENDER_BRAND_MISSING: the Work tree\'s brand/index.yaml carries no `brand:` specification block '
      ...
      + 'authors a human-readable `colour:` map instead of the `color.tokens`/`color.scales` shape checks/render.mjs parses.');
  }
