...
import {decodePng, checkPalette, checkEntityListInCard} from '../../checks/render.mjs';
 ...
 * newer `work/node@2` brand shape), so this script calls the same canon checks in checks/render.mjs
