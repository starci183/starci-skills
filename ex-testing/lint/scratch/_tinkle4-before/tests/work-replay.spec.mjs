...
import {checkTree, planCommand, runAssertion, collectAssertions, analyzeAssertion} from '../scripts/check-work-replay.mjs';

/**
 * Fixture trees for scripts/check-work-replay.mjs - one per behavior the replay engine promises:
