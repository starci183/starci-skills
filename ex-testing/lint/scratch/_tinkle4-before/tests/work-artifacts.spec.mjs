...
import {checkWorkArtifacts} from '../scripts/check-work-artifacts.mjs';
import {encodePng, screen} from './helpers/png.mjs';

/**
 * One fixture tree per byte rule in scripts/check-work-artifacts.mjs, proving each refuses the exact
