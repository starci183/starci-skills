...
import {checkWorkConsistencyTree, checkTreeParity, declaredStateValues} from '../scripts/check-work-consistency.mjs';
import {loadRecords} from '../scripts/example-ownership.mjs';
import {walk} from '../scripts/check-example-work.mjs';

/**
 * One fixture tree per cross-record rule in scripts/check-work-consistency.mjs, proving each rule fires on the
