...
| Mã | Ở đâu | Tìm gì |
|---|---|---|
| `LANDMARK-1` | `.claude/sources/fe/landmark.mjs` | `LANDMARK_BRANCHES` — tập tên branch mở landmark, mỗi element một entry. **Chưa neo được trong ứng dụng:** ứng dụng hiện mang element trên entry, nên không còn branch landmark nào để trỏ tới |
