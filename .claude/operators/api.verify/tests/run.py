...
OP="api.verify"
INPUT_COUNT=1
SPECS=[["api-verification","file","application/json"],["api-cases","file","application/json"],["api-verdicts","file","application/json"],["api-output","file","text/plain"]]
OBSERVE="evaluate-api-run"
