...
homes under `knowledge/compilers/patterns/be/`; this shelf selects and binds them without copying a ruling.

## Routes

| Accepted shape contains | Authority |
|---|---|
| Any backend file, import, operation, persistence, event, failure, test or transport decision | the reached child under `knowledge/compilers/patterns/be/<module>` |
| Complexity, semantic duplication, volatile outcome facts, repeated normalization, contradictory state or analysis provenance | `knowledge/compilers/patterns/be/maintainability` |
