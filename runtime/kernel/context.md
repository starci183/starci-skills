...
| Need | Runtime target |
|---|---|
| Source-wide language and verified project/role checkout | `knowledge/contexts/workspaces/context.md` |
| Durable decision state or rebuildable progress | `knowledge/contexts/worktrees/context.md` |
