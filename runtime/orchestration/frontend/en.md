...
|---|---|---|---|
| `@composition` | `knowledge/brainstorms/composition/en.md` | en | bind Scope, Owner, Invariant and Proof before visual decisions |
| `@directions` | `knowledge/brainstorms/directions/en.md` | en | preserve MASTER bypass and visual-direction limits |
| `@layouts` | `knowledge/brainstorms/layouts/en.md` | en | bind page synthesis, states, source ownership and staged approvals |
| `@blocks` | `knowledge/brainstorms/blocks/en.md` | en | bind block state-first anatomy and complete-parent proof |
| `@frontend-quality` | `knowledge/brainstorms/frontend-quality/en.md` | en | bind integrated frontend review and advisory-source boundary |
