...
|---|---|---|---|
| `@codex-orchestration` | `runtime/orchestration/codex/en.md` | en | map the common contract to Sol coordinator and Luna workers |
| `@claude-orchestration` | `runtime/orchestration/claude/en.md` | en | map the common contract to Opus coordinator and Sonnet workers |
| `@phase-maps` | `runtime/orchestration/maps/en.md` | en | route the selected physical skill to exactly one validated phase map |
