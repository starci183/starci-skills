...
|---|---|---|---|
| `@codex-orchestration` | `runtime/orchestration/codex/context.md` | context | map the common contract to Sol coordinator and Luna workers |
| `@claude-orchestration` | `runtime/orchestration/claude/context.md` | context | map the common contract to Opus coordinator and Sonnet workers |
| `@phase-maps` | `runtime/orchestration/maps/context.md` | context | route the selected physical skill to exactly one validated phase map |
| `@profiles` | `runtime/orchestration/profiles.json` | file | keep runtime model roles and concurrency machine-readable |
| `@receipt-schema` | `runtime/orchestration/receipt.schema.json` | file | define the internal machine-validated run record |
