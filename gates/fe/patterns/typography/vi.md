...
|---|---|---|
| `TYPESET-1` | `enforced` | `no-heading-tag-outside-heading-component` trong `.claude/sources/fe/typography.mjs` báo lỗi mọi `h1`–`h6` trong một file source không phải chính heading component |
...
| `TYPESET-2` | `src/components/leaves/Heading/index.tsx` · `.claude/sources/fe/typography.mjs` | Union cấp dừng ở `4`; hằng `DEEPEST_LEVEL` của rule cũng đúng `4` đó |
