...
| `interface.draw` | sol-fresh | yes | `fileread:context-aliases`, `git:read`, `imagegen:judged`, `print:decision-points`, `registry:read` | isolated | PNG direction within the frozen business and Grammar boundary |
...
| `landing.compose` | sol-reviewer | yes | `fileread:context-aliases`, `git:read`, `websearch:bounded` | isolated | Reasoning and evidence review within the operator boundary |
