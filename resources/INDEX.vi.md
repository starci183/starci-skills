...
| `frontend.surface.audit` | sol-reviewer | có | `fileread:context-aliases`, `git:read`, `websearch:bounded`, `visualize:html`, `browsercontrol:required`, `http:probe`, `host:loopback` | Chỉ trình duyệt, không ghi source: người audit không sửa được thứ mình đo |
