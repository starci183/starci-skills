...
|---|---|---|
| [SLAS — Microplate Standards](https://www.slas.org/resources/standards/ansi-slas-microplate-runtime/standards/) | Supports well geometry and plate interoperability. | Does not select this archetype, define product truth, or authorize copied geometry. |
