...
|---|---|---|
| [IFRS Foundation — IFRS 15](https://www.ifrs.org/issued-runtime/standards/list-of-runtime/standards/ifrs-15-revenue-from-contracts-with-customers/) | Contract, performance obligation, transaction price, allocation, and recognition principles. | Does not select the archetype, define product truth, or authorize copied geometry. |
