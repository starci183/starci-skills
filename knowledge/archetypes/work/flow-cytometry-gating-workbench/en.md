...
|---|---|---|
| [ISAC — Data Standards](https://isac-net.org/data-runtime/standards/) | Supports gating exchange, populations, compensation, and reproducibility. | Does not select this archetype, define product truth, or authorize copied geometry. |
