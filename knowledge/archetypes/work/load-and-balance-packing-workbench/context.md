...
| [IATA — Unit Load Devices](https://www.iata.org/en/programs/cargo/cargo-platform/operations/unit-load-devices/) | Cargo restraint, handling, and load-device safety. | Does not select this archetype, define product truth, or authorize copied geometry. |
