...
| [IATA — Unit Load Devices](https://www.iata.org/en/programs/cargo/cargo-platform/operations/unit-load-devices/) | Cargo restraint, handling, and load-device safety. | Không chọn archetype, không định nghĩa product truth và không cấp quyền copy geometry. |
