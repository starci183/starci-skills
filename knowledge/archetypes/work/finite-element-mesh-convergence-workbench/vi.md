...
| [ASME — V&V 10](https://www.asme.org/codes-runtime/standards/find-codes-runtime/standards/standard-for-verification-and-validation-in-computational-solid-mechanics) | Hỗ trợ computational solid-mechanics verification and validation. | Không chọn archetype này, không định nghĩa product truth và không cho phép sao chép geometry. |
