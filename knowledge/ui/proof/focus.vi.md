...
| Case 4 | Một lỗi đã được đo | Ghi lỗi thuộc giá trị chỉ dấu, thứ tự/phạm vi giam giữ/đường quay lại hay năng lực thiếu ở API cài thực tế đã kiểm tra. Xác định owner nhưng không thực thi op tiếp theo. |

Tập được chấm là `FOCUS-1` đến `FOCUS-5`; rule này chỉ tổng hợp và bản thân không được chấm.
