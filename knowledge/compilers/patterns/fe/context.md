...
|---|---|---|---|
| `@source-references` | `knowledge/compilers/patterns/source-references/context.md` | context | resolve immutable StarCi frontend precedent before a frontend pattern invents a shared module or family |
