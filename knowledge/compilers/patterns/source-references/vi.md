...
|---|---|---|---|
| `@catalog` | `knowledge/compilers/patterns/source-references/references.json` | file | gắn precedent FE và BE vào repository, commit và source root bất biến |
| `@resolve` | `knowledge/compilers/patterns/source-references/resolve.mjs` | script | kiểm tra checkout cục bộ đã khai báo hoặc materialize đúng commit vào workspace cache |
