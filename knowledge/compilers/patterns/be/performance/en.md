...
This pattern governs bounded answers, explicit relation loading, plan/index evidence and measurable
latency/resource budgets. It does not choose transport, data-access, authorization, naming, exception
identity, generic maintainability or testing mechanics; those modules remain authoritative for their
own boundaries.
