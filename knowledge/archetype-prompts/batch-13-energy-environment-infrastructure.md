...
- **Output boundary:** `knowledge/archetypes/work/power-system-protection-coordination-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Research anchors:** `FLUENT-LAYOUT`, `CARBON-TABLE`, `WAI-DRAG`, `WAI-FOCUS`, `WAI-STATUS`; add [NERC PRC-027-1](https://www.nerc.com/standards/reliability-runtime/standards/prc/prc-027-1) and [DOE integrated distribution system planning](https://www.energy.gov/oe/integrated-distribution-system-planning).
...
- **Output boundary:** `knowledge/archetypes/flow/grid-outage-restoration-switching-board/{en.md,vi.md,context.md,template.html}`.
...
- **Research anchors:** `ESRI-LAYOUT`, `CARBON-TABLE`, `WAI-FOCUS`, `WAI-OBSCURED`, `WAI-STATUS`; add [NERC EOP-005-3](https://www.nerc.com/globalassets/standards/reliability-runtime/standards/eop/eop-005-3.pdf), [OSHA 1910.269](https://www.osha.gov/laws-regs/regulations/standardnumber/1910/1910.269) and [PJM Manual 36 — System Restoration](https://learn.pjm.com/-/media/DotCom/documents/manuals/m36.ashx).
...
- **Output boundary:** `knowledge/archetypes/work/security-constrained-grid-dispatch-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Research anchors:** `CARBON-TABLE`, `FLUENT-LAYOUT`, `WAI-GRID`, `WAI-STATUS`, `WAI-FOCUS`; add [FERC 2024 Energy Primer](https://www.ferc.gov/media/energy-primer-handbook-energy-market-basics), [PJM Manual 11](https://learn.pjm.com/pjmfiles/directory/manuals/m11/index.html) and [NERC BAL-002-3](https://www.nerc.com/standards/reliability-runtime/standards/bal/bal-002-3).
...
- **Output boundary:** `knowledge/archetypes/work/distributed-energy-interconnection-study-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/prescribed-fire-ignition-window-control-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/power-grid-state-estimation-residual-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/water-network-leak-isolation-recovery-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/reservoir-release-rule-curve-coordinator/{en.md,vi.md,context.md,template.html}`.
...
- **Research anchors:** `CARBON-TABLE`, `FLUENT-LAYOUT`, `WAI-FOCUS`, `WAI-STATUS`, `WAI-REFLOW`; add [USACE reservoir-operation basics](https://www.hec.usace.army.mil/confluence/ResSimDocs/rsum/reservoir-platform/operations/reservoir-operations-the-basics), [USACE release decision rules](https://www.hec.usace.army.mil/confluence/cwmsdocs/rsum/reservoir-operations-the-rules-58631745.html) and [USACE rule-based operations guide](https://www.hec.usace.army.mil/confluence/hmsdocs/hmsguides/modeling-reservoirs-in-hec-hms/rule-based-reservoir-operations-quick-start-guide).
...
- **Output boundary:** `knowledge/archetypes/work/stormwater-catchment-control-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/rail-possession-access-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/bridge-defect-load-rating-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/earthwork-cut-fill-mass-haul-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/building-retrofit-measure-bundle-modeler/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/greenhouse-gas-inventory-consolidation-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/product-life-cycle-impact-assessment-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/industrial-symbiosis-exchange-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/contaminated-site-linkage-remediation-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/urban-heat-equity-intervention-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/materials-disassembly-recovery-sequence-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/groundwater-wellfield-pumping-allocation-workbench/{en.md,vi.md,context.md,template.html}`.
