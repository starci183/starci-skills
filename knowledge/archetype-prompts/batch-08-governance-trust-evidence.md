...
- **Output boundary:** `knowledge/archetypes/discovery/jurisdiction-authority-resolution/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/public-consultation-response-workspace/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/policy-obligation-authoring-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/cross-framework-traceability-mapper/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/settings/retention-disposition-policy-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/control-assurance-testing-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/literature-screening-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/evidence-extraction-synthesis-matrix/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/taxonomy-facet-modeling-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/treaty-reservation-depositary-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/settings/delegated-access-lifecycle-manager/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/support/communication-delivery-recovery-center/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/third-party-data-access-grant/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/support/active-session-threat-containment/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/automated-decision-explanation-challenge/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/consent-withdrawal-impact-review/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/regulatory-filing-package-validator/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/regulated-sample-selection-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/regulatory-comment-synthesis-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/retention-obligation-disposition-workbench/{en.md,vi.md,context.md,template.html}`.
