...
- **Output boundary:** `knowledge/archetypes/flow/waitlist-offer-allocation-board/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/circular-sequence-construct-designer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/formal-proof-obligation-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/orbital-conjunction-assessment-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/well-to-well-liquid-transfer-programmer/{en.md,vi.md,context.md,template.html}`.
...
- **Research anchors:** `WAI-GRID`, `WAI-DRAG`, `WAI-STATUS`, `WAI-REFLOW`; add [ANSI/SLAS microplate standards](https://www.slas.org/resources/standards/ansi-slas-microplate-runtime/standards/) and [SiLA 2 specification](https://sila-standard.com/wp-content/uploads/2022/03/SiLA-2-Part-A-Overview-Concepts-and-Core-Specification-v1.1.pdf).
...
- **Output boundary:** `knowledge/archetypes/work/memory-consistency-litmus-explorer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/detail/stream-window-join-debugger/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/flow-cytometry-gating-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Research anchors:** `WAI-TREEGRID`, `WAI-DRAG`, `WAI-STATUS`; add [ISAC data standards](https://isac-net.org/data-runtime/standards/), [NIST flow-cytometry gating](https://www.nist.gov/mml/bbd/quantification-cells-specific-phenotypic-characteristics) and [MIFlowCyt recommendation](https://pmc.ncbi.nlm.nih.gov/articles/PMC2773297/).
...
- **Output boundary:** `knowledge/archetypes/work/audio-mix-routing-console/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/print-signature-imposition-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/simultaneous-interpretation-channel-console/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/constraint-solver-unsat-core-explorer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/conflict-of-interest-recusal-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/typeface-glyph-metrics-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/multi-service-life-event-orchestrator/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/service-accommodation-commitment-plan/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/flight-dispatch-release-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/multi-payer-responsibility-coordinator/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/multi-creditor-hardship-plan-negotiator/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/support/interrupted-service-continuity-router/{en.md,vi.md,context.md,template.html}`.
