...
- **Output boundary:** `knowledge/archetypes/work/musical-temperament-beat-rate-tuning-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/interlinear-gloss-morpheme-alignment-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/mensural-notation-proportion-tactus-realization-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/archaeological-stratigraphic-phasing-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/serials-holdings-enumeration-gap-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/weaving-draft-liftplan-drawdown-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/musical-instrument-fingering-mechanism-mapper/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/braille-translation-contraction-proof-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/heraldic-blazon-emblazonment-roundtrip-validator/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/poetry-meter-scansion-prosody-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/vinyl-side-sequencing-groove-budget-planner/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/numismatic-specimen-die-linkage-analyzer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/organ-registration-coupler-piston-programmer/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/motion-capture-skeleton-retargeting-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/archaeological-fragment-refit-assembly-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/theatrical-counterweight-rigging-load-path-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/motion-picture-keycode-cut-list-conform-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/radio-frequency-interference-coordination-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/cinema-focus-pull-depth-of-field-rehearsal-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/bookbinding-collation-structure-reconstruction-workbench/{en.md,vi.md,context.md,template.html}`.
