...
- **Output boundary:** `knowledge/archetypes/work/double-entry-journal-posting-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/zero-coupon-yield-curve-bootstrap-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/corporate-action-election-entitlement-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/claims-development-triangle-reserving-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/performance-obligation-revenue-schedule-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Research anchors:** `CARBON-TABLE`, `WAI-FOCUS`, `WAI-OBSCURED`, `WAI-STATUS`; add [IFRS 15 Revenue from Contracts with Customers](https://www.ifrs.org/issued-runtime/standards/list-of-runtime/standards/ifrs-15-revenue-from-contracts-with-customers/) and [FASB revenue-recognition implementation Q&As](https://storage.fasb.org/Rev_Rec_Implementation_QAs.pdf).
...
- **Output boundary:** `knowledge/archetypes/work/hedge-accounting-designation-rebalancing-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Research anchors:** `FLUENT-LAYOUT`, `CARBON-TABLE`, `WAI-FOCUS`, `WAI-STATUS`; add [IFRS 9 Financial Instruments](https://www.ifrs.org/issued-runtime/standards/list-of-runtime/standards/ifrs-9-financial-instruments/) and [FASB ASU 2025-09 — Hedge Accounting Improvements](https://storage.fasb.org/ASU%202025-09.pdf).
...
- **Output boundary:** `knowledge/archetypes/work/multicurrency-netting-settlement-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/treasury-cash-pool-sweep-orchestrator/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/fund-nav-strike-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/collateral-margin-call-substitution-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/xbrl-fact-context-dimensional-validation-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/derivative-rate-reset-cashflow-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/capitalization-dilution-event-modeler/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/ranked-choice-round-tabulation-audit/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/derivatives-portfolio-compression-cycle-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/bank-regulatory-capital-rwa-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/flow/insolvency-priority-distribution-waterfall/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/roll-call-quorum-threshold-determination-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/customs-origin-valuation-duty-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/exchange-volatility-auction-reopening-console/{en.md,vi.md,context.md,template.html}`.
