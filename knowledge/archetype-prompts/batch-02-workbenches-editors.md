...
- **Output boundary:** `knowledge/archetypes/work/batch-table-platform/operations/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/spreadsheet-grid-editor/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/permissions-matrix/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/pivot-drilldown-analytics/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/streaming-log-console/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/calendar-resource-scheduler/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/kanban-swimlane-board/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/multi-party-consensus-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/reconciliation-diff-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/canvas-inspector-studio/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/palette-canvas-properties-builder/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/document-outline-editor/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/media-annotation-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/query-builder-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/rule-builder-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/workflow-automation-builder/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/localization-workbench/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/conversation-room/{en.md,vi.md,context.md,template.html}`.
...
- **Output boundary:** `knowledge/archetypes/work/dual-list-transfer/{en.md,vi.md,context.md,template.html}`.
