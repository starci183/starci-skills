...
Sau khi chọn asset, Common `MediaFrame` sở hữu aspect, fit, treatment, caption, frame semantics và geometry ổn định. Core chỉ sở hữu family presentation—crop discipline, border/radius/material và theme behavior. Dùng `contain` khi crop có thể làm mất meaning. Prop loading/error còn thiếu vẫn là Common gap. Binding: [MEDIA-1..6](../../ui/_pending-grammars-media.vi.md), [ICON-1..6](../../ui/_pending-grammars-icon.vi.md) và [RENDER-TRUTH-1..4](../../ui/proof/render-truth.vi.md).
