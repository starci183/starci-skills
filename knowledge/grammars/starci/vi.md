...
|---|---|---|---|
| `@grammar` | `knowledge/grammars/starci/grammar.json` | file | luật đóng từ fact sang outcome |
| `@facts` | `knowledge/grammars/starci/facts.json` | file | catalog fact quan sát được và đóng |
| `@capsules` | `knowledge/grammars/starci/capsules.json` | file | behavior bền vững, ruling và binding case/template |
| `@rulings` | `knowledge/grammars/starci/rulings.json` | file | owner statement đã normalize, scope và negative boundary |
| `@master-system` | `knowledge/grammars/starci/design-system.json` | file | một compact visual system dùng chung trước page deviation |
