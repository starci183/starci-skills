...
After selection, Common `MediaFrame` owns aspect, fit, treatment, caption, frame semantics, and stable geometry. Core owns only family presentation—crop discipline, border/radius/material, and theme behavior. Use `contain` when cropping could remove meaning. The missing loading/error prop remains a Common gap. Bindings: [MEDIA-1..6](../../ui/_pending-grammars-media.md), [ICON-1..6](../../ui/_pending-grammars-icon.md), and [RENDER-TRUTH-1..4](../../ui/proof/render-truth.md).
