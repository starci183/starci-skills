...
|---|---|---|---|
| `@feature-schema` | `knowledge/contexts/business/schema.json` | file | refuse unsupported or untraceable business claims |
| `@registry-schema` | `knowledge/contexts/business/registry.schema.json` | file | validate stable feature heads and immutable objects |
