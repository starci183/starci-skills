...
|---|---|---|---|
| `@feature-schema` | `knowledge/contexts/business/schema.json` | file | từ chối business claim không được hỗ trợ hoặc truy vết |
| `@registry-schema` | `knowledge/contexts/business/registry.schema.json` | file | validate stable feature head và immutable object |
