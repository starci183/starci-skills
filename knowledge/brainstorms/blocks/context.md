...
| `@frontend-quality` | `knowledge/brainstorms/frontend-quality/context.md` | context | challenge each direction through the shared craft, UX, accessibility, engineering and detector review |
