...
Design decides *which* component a shape of data takes (`design/component`). Architecture decides
*which tier* it lives in (`design/storybook`). These files decide how the code that results from
