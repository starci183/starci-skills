...
| [`landing-and-app-split-across-domains.md`](landing-and-app-split-across-domains.md) | that the marketing landing lives at the apex domain and the product app at the `app.` subdomain, and that a code split is one monorepo (apps + a shared design-system package) rather than two repos that would duplicate the design system |
