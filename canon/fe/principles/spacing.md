...
each scale is `design/storybook/architecture/principles/`. Where a number here and a number there
...
the used pixel value an auto margin resolved to and never the string itself — see `canon/fe/testing.md`.
