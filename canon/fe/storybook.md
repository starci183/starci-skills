...
`how-to-read-a-scan.md` says what a scan of your repo means. Once the tiers are clear,
[`split.md`](split.md) covers how a data-owning tier is written as two files — a presentational half
that a story can render, and a connected half that fetches — so the story tree and the app tree converge.
