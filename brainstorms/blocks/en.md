...
| `@frontend-quality` | `brainstorms/frontend-quality/en.md` | en | challenge each direction through the shared craft, UX, accessibility, engineering and detector review |
