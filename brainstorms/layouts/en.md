...
| `@frontend-quality` | `brainstorms/frontend-quality/en.md` | en | challenge every joined direction through integrated craft, UX, accessibility, engineering and detector lenses |
