...
export function validateSupervisionPolicy(policy){
  ...
  if(deadTerminals?.owner!=='workflow-manager'||deadTerminals?.command!=='sweep'||deadTerminals?.when!=='after-every-settlement-and-before-workflow-completion')errors.push('Dead-terminal sweep policy is invalid');
