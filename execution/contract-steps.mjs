...
export const SEQUENCES=['work.author','implement.ledger','implement.shared','implement.repair','implement.gate','interface.draw','interface.asset','frontend.implement','review.verify','e2e.verify','uat','uat.verify','operations','migration','architecture.revise','decide','generic'];
...
const LANE='Lane: this op is one step of `interface.draw` -> `interface.asset` (when the design record declares artwork slots) -> `frontend.implement` -> `uat.verify`; the node is done only after `uat.verify`.';
