...
import { generate } from '../../legacy/ops/generate.mjs';
...
const knowledgeCompilerPath = path.join(skillRoot, 'legacy', 'builders', 'compile-knowledge.mjs');
...
async function loadKnowledgeCompiler() {
  ...
  if (typeof mod.compileKnowledge !== 'function') {
    throw Error('legacy/builders/compile-knowledge.mjs must export compileKnowledge');
  }
