...
assert text.index("observe-store") < text.index("mutate-store")
assert "rollback is exact" in text.lower() and "shared or uncertain ownership" in text
assert "never replay blindly" in text and "credential values" in text
...
print("data.seed source and validator contract tests passed")
