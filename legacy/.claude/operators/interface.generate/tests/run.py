...
assert "visual" in request["properties"]["context"]["required"]
...
assert "selected baseline" in text and "unrelated art" in text
assert "delete rejected image" in text and "@workspaces/fe" in text
...
print("interface.generate source and validator contract tests passed")
