...
assert "stable account reference" in text and "fresh real login" in text
assert "never create a duplicate" in text.lower() and "no credential values" in text.lower()
assert "@tools/browsercontrol" in text and "@cli/curl" in text
...
print("identity.provision source and validator contract tests passed")
