...
OP="uat.verify"
INPUT_COUNT=1
SPECS=[["uat-flow-verification","file","application/json"],["uat-snapshot","file","application/json"],["uat-captures","file","application/json"],["uat-verdicts","file","application/json"],["uat-screenshots","image","image/png"]]
OBSERVE="evaluate-uat-run"
