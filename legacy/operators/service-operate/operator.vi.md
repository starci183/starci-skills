...
In **Operator Result** là trạng thái service được yêu cầu và đã quan sát cùng probe chứng minh trong `response/response.md`. Dừng do approval hoặc probe fail phải hiện service không đổi và owner của nó thay vì tuyên bố service đã được chuyển trạng thái.
