...
export function generate({check=false}={}) {
  throw Error('Source-tree generation is retired. The distless runtime reads modules/ops/ops/*.yaml and this legacy tree directly; there is no .dist to publish.');
}
