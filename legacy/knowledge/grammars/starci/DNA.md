...
| `--starci-core-control-min-size` | `2.75rem` |
...
| `--starci-core-rail-offset` | `var(--starci-core-band-offset, 5.5rem)` |
...
| `--starci-core-sidebar-collapsed-width` | `4rem` |
| `--starci-core-sidebar-width` | `16rem` |
| `--starci-core-subnav-offset` | `var(--starci-core-band-height, 4rem)` |
...
| `Button` `ButtonProps` | primitive | variant: `primary` \| `secondary` \| `tertiary` \| `outline` \| `ghost`; size: `sm` \| `md` \| `lg`; width: `content` \| `fill`; target: `_blank` \| `_self`; type: `button` \| `submit` \| `reset` | computed: MEASURE-2 | `starci-core-button` |
| `Divider` `DividerProps` | primitive | — | BOUNDARY-5 GAP-3 | `starci-core-divider` `starci-core-divider-rule` |
| `Heading` `HeadingProps` | primitive | level: `1` \| `2` \| `3` \| `4`; scale: `standard` \| `display` | computed: FONT-1 FONT-2 FONT-3 FONT-4 FONT-6 TONE-2 | — |
| `Icon` `IconProps` | primitive | usage: `heading` \| `leading` \| `chip` | — | `starci-core-icon` `starci-core-icon-skeleton` |
| `IconTile` `IconTileProps` | primitive | source: IconSource; tone: `neutral` \| `accent` \| `success` \| `warning` \| `danger`; size: `sm` \| `md` | computed: OVERFLOW-2 SURFACE-4 SURFACE-5 TONE-2 | `starci-core-icon-tile` |
| `IconButton` `IconButtonProps` | primitive | source: IconSource | — | `starci-core-icon-button` |
| `Label` `LabelProps` | primitive | depth: `top` \| `nested`; as: `span` \| `h3` | computed: FONT-1 FONT-2 MARGIN-0 | `starci-core-label` |
| `Input` `InputProps` | primitive | kind: `email` \| `password` \| `newPassword` \| `code` \| `text`; variant: `primary` \| `secondary` | FONT-1 GAP-2 TONE-2 | `starci-core-input` `starci-core-input-control` `starci-core-input-field` `starci-core-input-resting-control` `starci-core-input-resting-label` `starci-core-input-reveal` `starci-core-input-reveal-icon` `starci-core-input-reveal-label` |
| `PressableField` `PressableFieldProps` | primitive | source: IconSource | FLOW-4 FONT-1 FONT-2 GAP-2 MEASURE-2 PADDING-1 PADDING-3 SURFACE-4 TONE-1 TONE-2 | `starci-core-pressable-field` `starci-core-pressable-field-content` `starci-core-pressable-field-placeholder` `starci-core-pressable-field-shortcut` |
| `Progress` `ProgressProps` | primitive | — | MEASURE-2 | `starci-core-progress` |
| `Text` `TextProps` | primitive | as: `div` \| `p` \| `span`; size: `xs` \| `sm` \| `md` \| `metric-lead`; tone: `default` \| `muted` \| `accent`; weight: `normal` \| `medium` \| `semibold`; live: `off` \| `polite` \| `assertive`; overflow: `wrap` \| `truncate` \| `clamp-2` | computed: FONT-1 FONT-2 FONT-3 FONT-5 GAP-2 TONE-1 TONE-2 TONE-3 | `starci-core-text` |
| `TextAction` `TextActionProps` | primitive | appearance: ActionAppearance; size: ActionTextSize; target: `_blank` \| `_self` | computed: FONT-1 FONT-2 FONT-3 GAP-2 MEASURE-3 PADDING-1 PADDING-2 PADDING-3 SURFACE-4 TONE-1 TONE-2 TONE-3 | `starci-core-text-action-resting` |
...
| `PrimaryRailLayout` `PrimaryRailLayoutProps` | composition | railWidth: `compact` \| `standard` \| `wide`; align: `start` \| `stretch`; collapsedOrder: `primary-first` \| `rail-first` | GAP-5 | `starci-core-primary-rail-container` `starci-core-primary-rail-layout` `starci-core-primary-region` `starci-core-rail-region` |
...
| `Sidebar` `SidebarProps` | composition | source: IconSource; presentation: `rail` \| `drawer`; toggleSource: IconSource | FLOW-4 FONT-1 FONT-2 GAP-1 PADDING-0 PADDING-1 PADDING-2 PADDING-3 TONE-2 computed: GAP-3 MEASURE-2 MEASURE-6 OVERFLOW-2 SURFACE-4 TONE-1 | `starci-core-sidebar` `starci-core-sidebar-footer` `starci-core-sidebar-header` `starci-core-sidebar-item` `starci-core-sidebar-item-label` `starci-core-sidebar-item-trailing` `starci-core-sidebar-list` `starci-core-sidebar-section` `starci-core-sidebar-section-label` `starci-core-sidebar-toggle` |
...
| `MarkdownArticle` `MarkdownArticleProps` | branch | measure: `reading` \| `compact` | OVERFLOW-4 | `starci-core-fenced-code-block` `starci-core-fenced-code-header` `starci-core-markdown-article` `starci-core-markdown-table-frame` |
| `MarkdownTableFrame` `MarkdownTableFrameProps` | branch | measure: `reading` \| `compact` | OVERFLOW-4 | `starci-core-fenced-code-block` `starci-core-fenced-code-header` `starci-core-markdown-article` `starci-core-markdown-table-frame` |
| `SurfaceAccordionCard` `SurfaceAccordionCardProps` | branch | depth: `top` \| `nested` | BOUNDARY-3 GAP-2 MARGIN-0 PADDING-0 PADDING-3 PADDING-4 PADDING-5 TONE-1 computed: BOUNDARY-5 BOUNDARY-6 OVERFLOW-1 OVERFLOW-2 SURFACE-1 SURFACE-2 | `starci-core-accordion-body` `starci-core-accordion-heading` `starci-core-accordion-panel` `starci-core-accordion-root` `starci-core-accordion-row` `starci-core-accordion-scroll-region` `starci-core-accordion-shell` `starci-core-accordion-trigger` `starci-core-surface-accordion-card` |
...
| `Tabs` `TabsProps` | branch | labelVisibility: `responsive` \| `always`; inset: `page` \| `none` | FLOW-2 GAP-2 PADDING-3 computed: PADDING-5 | `starci-core-tab-content` `starci-core-tab-label` `starci-core-tabs` `starci-core-tabs-frame` `starci-core-tabs-scroll` |
