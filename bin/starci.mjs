...
const HELP = `starci — kernel-agent workflow runtime
  ...
  starci api <verb> [args]            kernel ledger gate: survey|status|hierarchy|plan|enqueue|estimate|route|dispatch|reconcile|nudge|observe|questions|messages|reply|peers|notify|inbox|foundations|foundation|settle|report|op-contract|check|consume-report|serve-ask|retire-ask|incident|provider-health|finish
