...
title: changelog.md
slug: /fe/layouts/laws/l1-persistent-owner-mounts-once/changelog
...
- **Sửa một liên kết chết trong [`INDEX.md`](./INDEX.md).** Mục `Law` trỏ tới
  `../../../principles/INDEX.md`, nhưng kệ `fe/principles` không có `INDEX.md` gốc — nó là một kệ
...
Lập mô-đun trên kệ `fe/layouts/`, từ ba dòng từ chối trên một hồ sơ và từ một lần đo lại toàn bộ
