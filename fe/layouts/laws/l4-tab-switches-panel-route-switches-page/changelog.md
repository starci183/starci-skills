...
title: changelog.md
slug: /fe/layouts/laws/l4-tab-switches-panel-route-switches-page/changelog
...
Mô-đun được lập lần đầu trên kệ `fe/layouts/laws/`, từ sáu dòng từ chối trên ba hồ sơ và từ một lần
