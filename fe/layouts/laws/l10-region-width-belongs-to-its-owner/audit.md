...
title: audit.md
slug: /fe/layouts/laws/l10-region-width-belongs-to-its-owner/audit
...
| Khoảng cách và đường phân cách giữa hai cột | KHÔNG thuộc L10. `gap-*` và `border-r` thuộc `fe/principles` |
