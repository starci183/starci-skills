...
title: INDEX.md
slug: /fe/layouts/laws/l2-assistant-and-content-are-different-axes
...
| The gate already carries the four regions of the assistant frame | neo CODE | `D:\Repositories\starci-academy-backend\.claude\fe\layouts\gate.schema.json:98-100` | — |
| The frame contract and the reused layout are both enumerable values | neo CODE | `D:\Repositories\starci-academy-backend\.claude\fe\layouts\gate.schema.json:473,500` | — |
