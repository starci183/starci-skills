...
title: changelog.md
slug: /fe/layouts/laws/l2-assistant-and-content-are-different-axes/changelog
...
Mô-đun được lập lần đầu trên kệ `fe/layouts/`, lấp một trong ba ô mà bảng định tuyến của kệ đang khai
