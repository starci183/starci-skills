---
id: fe-layouts-bang-chrome-tren-than-trang-example
title: example.md
slug: /fe/layouts/bang-chrome-tren-than-trang/example
...
> Phiên bản: `1.00` · Mô-đun: `bang-chrome-tren-than-trang` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
...
{
  "pageId": "cart",
  "archetype": "bang-chrome-tren-than-trang",
  "routeCluster": "cart",
...
```json
{
  ...
  "region": "main",
  "order": 1,
  "renderForm": "the-hoac-hang-nhan-state-tu-noi-goi",
  "reason": {
