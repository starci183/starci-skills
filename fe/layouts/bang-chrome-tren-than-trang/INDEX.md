---
id: fe-layouts-bang-chrome-tren-than-trang-index
title: INDEX.md
slug: /fe/layouts/bang-chrome-tren-than-trang
sidebar_label: bang-chrome-tren-than-trang
sidebar_position: 0
...
Version: `1.00` · Module: `bang-chrome-tren-than-trang` · Shelf: [`layouts`](../INDEX.md)
...
| Six clusters mount the band | `app\[lang]\{cart,courses,dashboard,league,practice,profile}\layout.tsx` — `courses\layout.tsx:31` |
| Body is a sibling of the band | `app\[lang]\courses\layout.tsx:28-41` (`nav-over-body-page`: `navigation` and `body` as peers) |
...
[`cot-dich-den-dung-canh-than-trang`](../cot-dich-den-dung-canh-than-trang/INDEX.md); a persistent
owner that draws nothing belongs to
[`nguoi-giu-phien-vo-hinh`](../nguoi-giu-phien-vo-hinh/INDEX.md).
