---
id: fe-layouts-cot-dich-den-dung-canh-than-trang-example
title: example.md
slug: /fe/layouts/cot-dich-den-dung-canh-than-trang/example
...
> Phiên bản: `1.00` · Mô-đun: `cot-dich-den-dung-canh-than-trang` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
...
```json
{
  ...
  "archetype": "cot-dich-den-dung-canh-than-trang",
  "archetypeReason": {
