---
id: fe-layouts-nguoi-giu-phien-vo-hinh-example
title: example.md
slug: /fe/layouts/nguoi-giu-phien-vo-hinh/example
...
> Phiên bản: `1.00` · Mô-đun: `nguoi-giu-phien-vo-hinh` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
...
```json
{
  ...
  "archetype": "nguoi-giu-phien-vo-hinh",
  "archetypeReason": {
...
|---|---|---|---|
| Hội thoại AI | Mọi cụm route | `app\[lang]\layout.tsx` | Chrome lặp theo cụm sẽ làm rơi hội thoại khi qua ranh giới cụm |
