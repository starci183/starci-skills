---
id: fe-blocks-archetypes-rail-quyet-dinh-mua-example
title: example.md
slug: /fe/blocks/archetypes/rail-quyet-dinh-mua/example
...
> Phiên bản: `2.00` · Mô-đun: `rail-quyet-dinh-mua` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
