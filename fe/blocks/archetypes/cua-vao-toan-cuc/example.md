---
id: fe-blocks-archetypes-cua-vao-toan-cuc-example
title: example.md
slug: /fe/blocks/archetypes/cua-vao-toan-cuc/example
...
> Phiên bản: `2.00` · Mô-đun: `cua-vao-toan-cuc` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
