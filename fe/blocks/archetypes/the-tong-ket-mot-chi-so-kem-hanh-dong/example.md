---
id: fe-blocks-archetypes-the-tong-ket-mot-chi-so-kem-hanh-dong-example
title: example.md
slug: /fe/blocks/archetypes/the-tong-ket-mot-chi-so-kem-hanh-dong/example
...
> Phiên bản: `2.00` · Mô-đun: `the-tong-ket-mot-chi-so-kem-hanh-dong` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
