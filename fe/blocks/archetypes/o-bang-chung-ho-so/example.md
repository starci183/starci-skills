---
id: fe-blocks-archetypes-o-bang-chung-ho-so-example
title: example.md
slug: /fe/blocks/archetypes/o-bang-chung-ho-so/example
...
> Phiên bản: `2.00` · Mô-đun: `o-bang-chung-ho-so` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
