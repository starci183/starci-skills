---
id: fe-blocks-archetypes-hang-chi-so-khong-mat-phang-example
title: example.md
slug: /fe/blocks/archetypes/hang-chi-so-khong-mat-phang/example
...
> Phiên bản: `2.00` · Mô-đun: `hang-chi-so-khong-mat-phang` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
