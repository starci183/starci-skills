...
slug: /fe/blocks/proofs/course-details
...
Đầu ra gate layouts, không có nguyên văn. Phần đọc lại được: cột đọc + cột cam kết sticky + dải ghim đáy, bốn state màn hình. Cộng câu nghiệp vụ (`.claude/fe/layouts/proofs/course-details.md` § IN).
