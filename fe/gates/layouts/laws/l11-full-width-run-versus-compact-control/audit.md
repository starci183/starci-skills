...
title: audit.md
slug: /gates/layouts/laws/l11-full-width-run-versus-compact-control/audit
...
- **Gate không có trường nào cho luật này.** `gate.schema.json` có `Region.widthOwner` ở `:290` và
  ...
  Neo: `D:\Repositories\starci-academy-backend\.claude\gates\layouts\gate.schema.json:290,295,326-359`.
