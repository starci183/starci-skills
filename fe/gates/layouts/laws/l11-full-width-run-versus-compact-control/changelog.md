...
title: changelog.md
slug: /gates/layouts/laws/l11-full-width-run-versus-compact-control/changelog
...
Mô-đun được lập lần đầu trên kệ `gates/layouts/laws/`, từ sáu dòng từ chối trong một hồ sơ và từ một lần
