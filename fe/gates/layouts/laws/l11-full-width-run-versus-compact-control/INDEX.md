...
title: INDEX.md
slug: /gates/layouts/laws/l11-full-width-run-versus-compact-control
...
| The gate has fields for a region's width and none for a control's shape | neo CODE | `D:\Repositories\starci-academy-backend\.claude\gates\layouts\gate.schema.json:290,295,326-359` | — |
