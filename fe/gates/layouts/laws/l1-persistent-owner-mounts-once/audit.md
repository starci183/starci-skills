...
title: audit.md
slug: /gates/layouts/laws/l1-persistent-owner-mounts-once/audit
...
- **Nợ bình luận cũ trong mã.** Doc comment ở
  ...
  chủ.
- **Nợ trong chính cây trust.** Bảng định tuyến ở `.claude\gates\layouts\INDEX.md:96` vẫn ghi L1 ở dạng
