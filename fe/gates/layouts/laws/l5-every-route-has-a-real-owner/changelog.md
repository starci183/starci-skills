...
title: changelog.md
slug: /gates/layouts/laws/l5-every-route-has-a-real-owner/changelog
...
Mô-đun được lập lần đầu trên kệ `gates/layouts/`, từ mười một dòng từ chối trên hai hồ sơ và từ một lần
