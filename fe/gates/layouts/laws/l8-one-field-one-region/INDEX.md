...
title: INDEX.md
slug: /gates/layouts/laws/l8-one-field-one-region
...
and with which block is [`gates/blocks`](../../../blocks/INDEX.md). The seam between two slots and the
inset around them is [`gates/principles`](../../../principles/gap/INDEX.md). Neither appears in this
module's output.
...
what the empty and failed branches show. Those are [`gates/blocks`](../../../blocks/INDEX.md), read
