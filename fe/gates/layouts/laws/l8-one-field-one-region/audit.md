...
title: audit.md
slug: /gates/layouts/laws/l8-one-field-one-region/audit
...
| `L8-5` so với `gates/principles` | **Chồng lấn thật.** Xem `Nhận định` |
...
- Điểm chồng lấn thật với `gates/principles` nằm ở `L8-5`. Luật này quyết có mấy trường, và câu trả lời
  ...
  số slot còn `gates/principles` phát ra class, nhưng một người viết kế hoạch rất dễ chép luôn cả class
