...
title: changelog.md
slug: /gates/layouts/laws/l8-one-field-one-region/changelog
...
Mô-đun được lập lần đầu trên kệ `gates/layouts/`, từ bốn dòng từ chối trên ba hồ sơ và từ một lần đọc
