...
title: INDEX.md
slug: /gates/layouts/laws/l7-overlay-width-is-a-product-decision
...
| The gate field exists and its enum is smaller than the measured set | neo CODE | `D:\Repositories\starci-academy-backend\.claude\gates\layouts\gate.schema.json:382-385` | — |
