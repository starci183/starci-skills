...
title: audit.md
slug: /gates/layouts/laws/l7-overlay-width-is-a-product-decision/audit
...
- **Gate đang khai sai, và nó khai sai bằng một câu khẳng định.**
  `D:\Repositories\starci-academy-backend\.claude\gates\layouts\gate.schema.json:382-385` có sẵn trường
