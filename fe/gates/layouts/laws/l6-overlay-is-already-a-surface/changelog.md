...
title: changelog.md
slug: /gates/layouts/laws/l6-overlay-is-already-a-surface/changelog
...
Mô-đun được lập lần đầu trên kệ `gates/layouts/`, tách `L6` ra khỏi vế ngắn mà nó đang nằm trong
