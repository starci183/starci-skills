...
title: changelog.md
slug: /gates/layouts/laws/l10-region-width-belongs-to-its-owner/changelog
...
Mô-đun được lập lần đầu trên kệ `gates/layouts/`, từ sáu dòng từ chối trên bốn hồ sơ và từ một lần đo
