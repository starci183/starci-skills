...
title: INDEX.md
slug: /gates/layouts/laws/l10-region-width-belongs-to-its-owner
...
decide the gap or the seam between the columns, which belong to `gates/principles`; it does not decide
