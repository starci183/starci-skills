...
title: INDEX.md
slug: /gates/layouts/laws/l9-sticky-offset-is-page-local
...
it is drawn belongs to `gates/blocks` and `gates/principles`.
...
z-index order, the seam paint or the inset, which are `gates/principles` and are read after this module
has closed.
