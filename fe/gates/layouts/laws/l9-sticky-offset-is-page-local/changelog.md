...
title: changelog.md
slug: /gates/layouts/laws/l9-sticky-offset-is-page-local/changelog
...
Mô-đun được lập lần đầu trên kệ `gates/layouts/`, từ năm dòng từ chối trên hai hồ sơ và từ một lần đếm
