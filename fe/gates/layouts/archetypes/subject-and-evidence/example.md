---
id: fe-layouts-archetypes-subject-and-evidence-example
title: example.md
slug: /gates/layouts/archetypes/subject-and-evidence/example
...
> Phiên bản: `1.00` · Mô-đun: `subject-and-evidence` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
...
```json
{
  ...
  "archetype": "subject-and-evidence",
  "archetypeReason": {
