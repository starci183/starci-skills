---
id: fe-layouts-archetypes-subject-and-evidence-index
title: INDEX.md
slug: /gates/layouts/archetypes/subject-and-evidence
sidebar_label: subject-and-evidence
sidebar_position: 0
...
Version: `1.00` · Module: `subject-and-evidence` · Shelf: [`layouts`](../../INDEX.md)
...
- The rail holds the subject; it is never a navigation column. A column of destinations is
  [`destination-column`](../destination-column/INDEX.md).
...
- **`IDENT-4` is the one place tabs ARE routing.** Elsewhere a tab changes a panel; here each face has
  ...
  [`sticky-chrome-band`](../sticky-chrome-band/INDEX.md).
