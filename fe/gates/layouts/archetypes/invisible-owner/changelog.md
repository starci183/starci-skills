---
id: fe-layouts-archetypes-invisible-owner-changelog
title: changelog.md
slug: /gates/layouts/archetypes/invisible-owner/changelog
...
> Phiên bản hiện tại: `1.00` · Mô-đun: `invisible-owner`
...
- **Đặt archetype.** `invisible-owner` phục vụ `GlobalAiChatLayout` (toàn bộ 51 page trừ
...
- **`KEEPER-6` viết ở cả hai mô-đun** — ở đây và ở
  [`destination-column`](../destination-column/INDEX.md) — vì vi phạm
