---
id: fe-layouts-archetypes-destination-column-changelog
title: changelog.md
slug: /gates/layouts/archetypes/destination-column/changelog
...
> Phiên bản hiện tại: `1.00` · Mô-đun: `destination-column`
...
- **Đặt archetype.** `destination-column` phục vụ 33 page: 30 route learn qua
