---
id: fe-layouts-archetypes-destination-column-audit
title: audit.md
slug: /gates/layouts/archetypes/destination-column/audit
...
> Phiên bản: `1.00` · Mô-đun: `destination-column`
...
| Phép thử | Kết quả |
|---|---|
| Cột đích đến so với cột danh tính | Loại trừ được: cột này chứa **nơi để đi**, cột kia chứa **một người**. Xem mô-đun `subject-and-evidence` |
