---
id: fe-layouts-archetypes-destination-column-index
title: INDEX.md
slug: /gates/layouts/archetypes/destination-column
sidebar_label: destination-column
sidebar_position: 0
...
Version: `1.00` · Module: `destination-column` · Shelf: [`layouts`](../../INDEX.md)
...
| Doors, live | `src\app\[lang]\courses\[displayId]\learn\page.tsx` redirects to `/learn/content` |
...
[`subject-and-evidence`](../subject-and-evidence/INDEX.md). The band
above this frame is [`sticky-chrome-band`](../sticky-chrome-band/INDEX.md), and its
