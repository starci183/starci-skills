---
id: fe-layouts-archetypes-sticky-chrome-band-changelog
title: changelog.md
slug: /gates/layouts/archetypes/sticky-chrome-band/changelog
...
> Phiên bản hiện tại: `1.00` · Mô-đun: `sticky-chrome-band`
...
- **Đặt archetype.** `sticky-chrome-band` phục vụ 6 cụm route và 49/51 page, tất cả dùng
