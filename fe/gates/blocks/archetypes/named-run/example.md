---
id: fe-blocks-archetypes-named-run-example
title: example.md
slug: /gates/blocks/archetypes/named-run/example
...
> Phiên bản: `2.00` · Mô-đun: `named-run` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
