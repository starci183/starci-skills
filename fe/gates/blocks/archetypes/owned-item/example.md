---
id: fe-blocks-archetypes-owned-item-example
title: example.md
slug: /gates/blocks/archetypes/owned-item/example
...
> Phiên bản: `2.00` · Mô-đun: `owned-item` · Luật: [`INDEX.md`](./INDEX.md) · Tình huống: [`vi.md`](./vi.md) · Phản biện: [`audit.md`](./audit.md)
