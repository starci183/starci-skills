...
title: audit.md
slug: /gates/blocks/laws/b8-group-before-gap/audit
...
| Phép thử | Kết quả |
|---|---|
| `B8` so với `gates/principles/gap` | Loại trừ được: ở đây quyết định **có nhóm nào**, ở kia quyết định **khoảng cách bao nhiêu** |
...
- Mô-đun này cố ý **không** nêu một giá trị khoảng cách nào. Nếu có ai thêm vào, nó đã lấn sang
  `gates/principles/gap` và phải chuyển đi.
