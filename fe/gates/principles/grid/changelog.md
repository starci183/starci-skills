...
title: changelog.md
slug: /gates/principles/grid/changelog
...
`gates/principles/`. Không có `1.x`: trước bản này câu hỏi mà nó nhận không thuộc về ai cả, và đó chính
...
- **Đứng trên nhóm nào.** `gates/principles/grid/`. Nhóm `principles/` giữ các nguyên tắc dựng hình
