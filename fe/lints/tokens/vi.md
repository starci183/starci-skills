...
**Cách phát hiện.** Một biểu thức chính quy duy nhất chạy trên chuỗi đã nối: liệt kê 25 tên họ
...
**Vì sao luật này đáng có máy giữ.** Các rung là số nguyên và **thưa không đều**, nên nửa rung không
...
**Cửa còn mở.** Bốn họ kích thước bị thiếu: `min-w-3.5`, `min-h-1.5`, `max-w-2.5`, `max-h-1.5` đều
...
**Cách phát hiện.** Hai biểu thức chính quy. Bên độ dài liệt kê 21 họ — tập giãn cách và kích thước
...
**Vì sao luật này đáng có máy giữ.** Một giá trị trong ngoặc vuông là giá trị **được chọn một lần,
...
**Cửa còn mở.** Tên luật hứa "mọi giá trị tuỳ ý", biểu thức chính quy chỉ phủ giãn cách và kích
...
**Cách phát hiện.** Hai biểu thức chính quy, cả hai phải `test` đúng trên cùng một chuỗi:
`text-(xl|2xl|3xl|4xl|5xl)` và `font-(bold|extrabold|black)`.

**Vì sao luật này đáng có máy giữ.** Chữ lớn cộng nét đậm **là** một tiêu đề, dù nó nằm trên thẻ
...
**Cửa còn mở.** `font-semibold` **không** nằm trong danh sách nét đậm, mà `text-2xl font-semibold`
...
**Cách phát hiện.** Luật này lấy bằng chứng từ **hệ tệp**, không từ cây cú pháp. Từ thư mục của tệp
...
**Vì sao luật này đáng có máy giữ.** Đây là **giá trị chết duy nhất mà một kiểu đóng không bắt
...
**Cửa còn mở.** **Không có tệp kiểu dáng thì không có luật**: một kho để chủ đề ở đường dẫn khác sẽ
