...
| `@workspaces` | `knowledge/contexts/workspaces/en.md` | en | prove every repository named by the deployment |
| `@worktrees` | `knowledge/contexts/worktrees/en.md` | en | keep durable intent separate from rebuildable execution state |
