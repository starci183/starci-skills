...
|---|---|---|---|
| `@initialization-identity` | `platform/readiness/initialization/identity/context.md` | context | machine decrypt readiness |
| `@initialization-bootstrap` | `platform/readiness/initialization/bootstrap/context.md` | context | agent entry routing |
| `@initialization-workspaces` | `platform/readiness/initialization/workspaces/context.md` | context | Source language and read routes |
| `@initialization-worktrees` | `platform/readiness/initialization/worktrees/context.md` | context | project write roots |
