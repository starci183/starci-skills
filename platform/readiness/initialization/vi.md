...
|---|---|---|---|
| `@initialization-identity` | `platform/readiness/initialization/identity/vi.md` | vi | machine decrypt readiness |
| `@initialization-bootstrap` | `platform/readiness/initialization/bootstrap/vi.md` | vi | route agent entry |
| `@initialization-workspaces` | `platform/readiness/initialization/workspaces/vi.md` | vi | ngôn ngữ Source và read route |
| `@initialization-worktrees` | `platform/readiness/initialization/worktrees/vi.md` | vi | write root của project |
