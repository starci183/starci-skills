...
|---|---|---|---|
| `@stale-source-gates` | `platform/readiness/staleness/source-gates/vi.md` | vi | declared project gate và source finding |
| `@stale-port-offset` | `platform/readiness/staleness/port-offset/vi.md` | vi | family offset, application slot và collision proof do Source sở hữu |
| `@stale-lint-machine` | `platform/readiness/staleness/lint-machine/vi.md` | vi | canon adoption và vendored-rule detection |
| `@stale-strict-fix` | `platform/readiness/staleness/strict-fix/vi.md` | vi | first-party Prettier integration |
| `@stale-why` | `platform/readiness/staleness/why/vi.md` | vi | contract index findability |
| `@stale-assurance` | `platform/readiness/staleness/assurance/vi.md` | vi | applicability và delivery fence của frontend lẫn backend |
| `@stale-debts` | `platform/readiness/staleness/debts/vi.md` | vi | nợ chất lượng có owner duyệt, baseline và hạn |
| `@stale-retired-structure` | `platform/readiness/staleness/retired-structure/vi.md` | vi | component tier đã bỏ, kể cả path rỗng |
| `@stale-remnant` | `platform/readiness/staleness/remnant/vi.md` | vi | legacy `.claude/` tree nested |
