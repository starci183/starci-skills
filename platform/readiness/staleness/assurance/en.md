...
|---|---|---|---|
| `@assurance-be` | `knowledge/compilers/patterns/be/delivery-assurance/en.md` | en | authoritative seven-part backend fence |
| `@assurance-fe` | `knowledge/compilers/patterns/fe/delivery-assurance/en.md` | en | authoritative seven-part frontend fence |
| `@stale-debts` | `platform/readiness/staleness/debts/en.md` | en | owner-approved temporary coverage/Sonar debt |
