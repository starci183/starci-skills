...
|---|---|---|---|
| `@stale-source-gates` | `platform/readiness/staleness/source-gates/en.md` | en | declared project gates and source findings |
| `@stale-port-offset` | `platform/readiness/staleness/port-offset/en.md` | en | Source-owned family offsets, application slots and collision proof |
| `@stale-lint-machine` | `platform/readiness/staleness/lint-machine/en.md` | en | canon adoption and vendored-rule detection |
| `@stale-strict-fix` | `platform/readiness/staleness/strict-fix/en.md` | en | first-party Prettier integration |
| `@stale-why` | `platform/readiness/staleness/why/en.md` | en | contract index findability |
| `@stale-assurance` | `platform/readiness/staleness/assurance/en.md` | en | frontend and backend delivery assurance applicability and fence |
| `@stale-debts` | `platform/readiness/staleness/debts/en.md` | en | owner-approved, measured, expiring quality debt |
| `@stale-retired-structure` | `platform/readiness/staleness/retired-structure/en.md` | en | removed component tiers including empty paths |
| `@stale-remnant` | `platform/readiness/staleness/remnant/en.md` | en | nested legacy `.claude/` trees |
