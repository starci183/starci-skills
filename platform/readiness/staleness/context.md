...
|---|---|---|---|
| `@stale-source-gates` | `platform/readiness/staleness/source-gates/context.md` | context | declared project gates and source findings |
| `@stale-port-offset` | `platform/readiness/staleness/port-offset/context.md` | context | Source-owned family offsets, application slots and collision proof |
| `@stale-lint-machine` | `platform/readiness/staleness/lint-machine/context.md` | context | canon adoption and vendored-rule detection |
| `@stale-strict-fix` | `platform/readiness/staleness/strict-fix/context.md` | context | first-party Prettier integration |
| `@stale-why` | `platform/readiness/staleness/why/context.md` | context | contract index findability |
| `@stale-assurance` | `platform/readiness/staleness/assurance/context.md` | context | frontend and backend delivery assurance applicability and fence |
| `@stale-debts` | `platform/readiness/staleness/debts/context.md` | context | owner-approved, measured, expiring quality debt |
| `@stale-retired-structure` | `platform/readiness/staleness/retired-structure/context.md` | context | removed component tiers including empty paths |
| `@stale-remnant` | `platform/readiness/staleness/remnant/context.md` | context | nested legacy `.claude/` trees |
