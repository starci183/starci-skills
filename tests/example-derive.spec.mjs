...
test('usedBy: work/contract@1 provenBy.provider/consumer land under contractProvider/contractConsumer, not generic provenBy', () => {
  const workRoot = tree({
...
test('effectiveState: a matching digest and no blockers leaves the authored state alone', () => {
  const recordBody = 'schema: work/business-rule@1\nid: br.f.a\ntitle: A\nstate: done\nverificationSource: authored-claim\nbecause: c\n';
...
test('effectiveState: a code-stale codeDigest suspends a done record even though recordDigest still matches (concept 1)', () => {
  const recordBody = 'schema: work/implementation@1\nid: impl.f.a\ntitle: A\nstate: done\nrepository: r\nowners: [{role: module, path: src/f}]\nverificationSource: authored-claim\nbecause: c\n';
...
test('effectiveState: appliesTo-newer-than-evidence suspends a done record whose digest still matches', () => {
  const recordBody = 'schema: work/functional-requirement@1\nid: fr.f.a\ntitle: A\nstate: done\nverificationSource: authored-claim\nbecause: c\n';
  const workRoot = tree({
    'features/f/fr/a/index.yaml': recordBody,
    'features/f/sds/guard/index.yaml': 'schema: work/sds-component@1\nid: sds.f.guard\ntitle: Guard\nstate: todo\nappliesTo: [fr.f.a]\nchange: {rev: 1, kind: breaking, at: 2026-09-18T09:00:00.000Z}\n',
  });
...
test('blockers: a blocked record\'s chain resolves through an intermediate record to its gap', () => {
  const workRoot = tree({
    ...
    'features/f/sds/mid/index.yaml': 'schema: work/sds-component@1\nid: sds.f.mid\ntitle: Mid\nstate: todo\nblockedBy:\n  - {record: gap.f.absence, because: "no module to build against"}\n',
...
test('frontier: excludes a blocked todo, includes an unblocked one, sorted by feature then id', () => {
  const workRoot = tree({
    'features/f/gap/absence/index.yaml': 'schema: work/gap@1\nid: gap.f.absence\ntitle: Missing\nstate: todo\nstatement: s\n',
    'features/f/br/blocked/index.yaml': 'schema: work/business-rule@1\nid: br.f.blocked\ntitle: Blocked\nstate: todo\nblockedBy:\n  - {record: gap.f.absence, because: "no module"}\n',
    'features/f/br/free/index.yaml': 'schema: work/business-rule@1\nid: br.f.free\ntitle: Free\nstate: todo\n',
    'features/f/br/done/index.yaml': 'schema: work/business-rule@1\nid: br.f.done\ntitle: Done\nstate: done\nverificationSource: authored-claim\nbecause: c\n',
  });
  const derived = computeDerived(workRoot);
...
test('tally: done/todo/stale/blocked partition every record with a lifecycle state, per feature and overall', () => {
  const workRoot = tree({
    'features/f/br/done/index.yaml': 'schema: work/business-rule@1\nid: br.f.done\ntitle: Done\nstate: done\nverificationSource: authored-claim\nbecause: c\n',
    'features/f/br/todo/index.yaml': 'schema: work/business-rule@1\nid: br.f.todo\ntitle: Todo\nstate: todo\n',
    'features/f/gap/absence/index.yaml': 'schema: work/gap@1\nid: gap.f.absence\ntitle: Missing\nstate: todo\nstatement: s\n',
    'features/f/br/blocked/index.yaml': 'schema: work/business-rule@1\nid: br.f.blocked\ntitle: Blocked\nstate: todo\nblockedBy:\n  - {record: gap.f.absence, because: "no module"}\n',
    'features/f/ac/leaf/index.yaml': 'schema: work/acceptance-criterion@1\nid: ac.f.leaf\nrule: br.f.done\ngiven: g\nwhen: w\nthen: [t]\n',
  });
