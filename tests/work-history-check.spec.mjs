...
import {checkWorkHistoryTree} from '../scripts/checks/check-work-history.mjs';

/**
 * One git repository per fixture, built step by step, proving each change-discipline rule in
 * scripts/checks/check-work-history.mjs refuses the transition it targets - and that the cases it must NOT refuse (a
