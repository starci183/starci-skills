...
const mode=args.includes('--decrypt')?'decrypt':args.includes('--encrypt')?'encrypt':null;
if(!mode||!file||!fs.existsSync(file)){process.stderr.write('fake sops: expected --encrypt or --decrypt and a file\n');process.exit(2);}
