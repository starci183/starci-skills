...
This is the unchanged specification recorded before implementation. The later user instruction “cam 3agent parralel cook het roi push” authorized implementing and pushing it. Pending wording below describes that earlier stage; current status is in TODO.md section 9 and the release evidence.
