...
|---|---|
| Decision về file, import, operation, persistence, event, failure, test hoặc transport backend | child được route tới dưới `compilers/patterns/be/<module>` |
| Complexity, semantic duplication, volatile facts, normalize lặp, state mâu thuẫn hoặc analysis provenance | `compilers/patterns/be/maintainability` |
