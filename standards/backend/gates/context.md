...
|---|---|
| Canonical ESLint finding | `gates/be/lints/context.md` |
| Quality/coverage/analysis delivery finding | `readiness/staleness/assurance/context.md` |
| Check-only repository source-gate failure | `readiness/staleness/source-gates/context.md` |
