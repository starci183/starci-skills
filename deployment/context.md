...
| `@workspaces` | `contexts/workspaces/context.md` | context | prove every repository named by the deployment |
| `@worktrees` | `contexts/worktrees/context.md` | context | keep durable intent separate from rebuildable execution state |
