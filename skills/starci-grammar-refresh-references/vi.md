...
| `@workspaces` | `knowledge/contexts/workspaces/vi.md` | vi | resolve đúng grammar/profile role project đã chọn |
| `@grammar` | `knowledge/grammars` | module | durable grammar authority mà optional ref không được đổi |
