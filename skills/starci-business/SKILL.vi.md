# starci-business — bản đọc tiếng Việt

Bản [SKILL.md](SKILL.md) tiếng Anh là runtime authority. Viết và đối chiếu intent, yêu cầu, luật và acceptance cho nghiệp vụ được chọn.
...
Tách functional requirements, non-functional requirements, business rules, loại trừ và acceptance quan sát được. Ghi rõ implement/defer/not-applicable. Reconcile báo mâu thuẫn source/runtime nhưng không nâng chúng thành intent được duyệt. Review cuối chỉ chứng minh quyết định nghiệp vụ đã chọn, không claim implementation hoặc UAT.
