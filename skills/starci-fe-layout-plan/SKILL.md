...
A missing context exits non-zero and prints the command that fixes it; `starci-setup-workspace`
...
| `test.mjs` | run after any change: `node .claude/skills/starci-fe-layout-plan/test.mjs` |
