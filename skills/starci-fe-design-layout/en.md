...
- Missing route, grammar/profile, business truth, contract, source baseline or scope boundary.
- Fabricated content, incomplete states, non-functional previews or fewer than three real alternatives.
- New product truth without business authority.
- Required work outside the approved source boundary.

## OUTPUT

Report candidates, recommendation, cache review URL and exact source boundary; after `OK`, report changed source paths and real-product proof. Never report registry heads or revision hashes.
