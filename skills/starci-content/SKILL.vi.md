# starci-content — bản đọc tiếng Việt

Bản [SKILL.md](SKILL.md) tiếng Anh là runtime authority. Tạo content có nguồn, compose vào landing được chọn rồi inspect bản render.
...
Dựa vào nguồn factual, audience và ngôn ngữ đã duyệt; claim không đủ nguồn còn unresolved. Chỉ compose surface landing được chọn. Audit cần render/evidence thật; preview tạo không chứng minh app. Không tự publish công khai hay deploy ngoài scope người dùng.
