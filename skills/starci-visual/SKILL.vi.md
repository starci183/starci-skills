# starci-visual — bản đọc tiếng Việt

Bản [SKILL.md](SKILL.md) tiếng Anh là runtime authority. Plan và vẽ direction hoặc concept UI được chọn; không claim code đã giao hoặc browser UAT.
...
Chỉ tạo concept/artifact và direction được yêu cầu. Dùng tool ảnh/design thực sự có và được phép; không giả định khả năng. Ghi rõ mockup/ảnh tạo. Đây không phải screenshot của sản phẩm đang chạy, completion code hay proof hành vi.
