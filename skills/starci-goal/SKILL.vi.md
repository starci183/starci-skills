# starci-goal — bản đọc tiếng Việt

Bản [SKILL.md](SKILL.md) tiếng Anh là runtime authority. Thiết lập một mục đích nghiệp vụ và cây Work ban đầu; không tự triển khai sản phẩm.
...
Chọn scope một mục đích; chỉ tạo goal native của task hiện tại khi người dùng yêu cầu rõ và công cụ thực sự hỗ trợ. Không bịa yêu cầu hay resource repo. Setup chỉ khai báo các target binding/business-review đã được chọn; từng target còn chưa hoàn thành đến khi có proof riêng.
