...
description: Sửa hoặc tái cấu trúc exact frontend scope đã được Layout hay Block render. Feedback cụ thể của owner chứng minh authority, reasoning, enforcement hoặc source application của skill sinh output đã sai; evolve tầng bền vững nhỏ nhất, refactor mọi consumer bị ảnh hưởng rồi prove real product. Mặc định một direction; 3–4 chỉ khi owner explicit brainstorm. Product truth và backend giữ nguyên.
---
...
Owner feedback từ chối visual result đã emit hoặc implement chứng minh skill sinh output đã không resolve, apply
hoặc enforce đúng authority. Reproduce feedback và classify tầng cao nhất đã fail thành `law-misruling`,
...
1. Owner feedback là failed-skill signal, không phải feedback workflow riêng hoặc taste patch.
