---
name: starci-deploy
description: Adopt, set up, deploy, monitor, recover or roll back a routed project's declared .stacks deployment through generated .infra execution state, SSH host control, the declared domain driver and immutable release workflows. Continues repair and retry until public steady state; not for local development startup or an undeclared external host.
---
