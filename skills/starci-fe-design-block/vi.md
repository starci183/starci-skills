...
- Product behavior chưa rõ, state thiếu, preview không functional hoặc ít hơn ba alternative thật.
- Work bắt buộc nằm ngoài approved source boundary.

## OUTPUT

Báo candidate, recommendation, cache URL và exact source path; sau `OK`, báo changed path và full-page proof. Không báo registry identity.
