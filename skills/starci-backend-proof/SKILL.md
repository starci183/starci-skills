...
Close one backend delivery with contract, implementation, migration, runtime, and semantic conformance evidence. Use after implementation conformance; do not repair source.
