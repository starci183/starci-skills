# starci-architecture — bản đọc tiếng Việt

Bản [SKILL.md](SKILL.md) tiếng Anh là runtime authority. Chốt kiến trúc và kế hoạch backend, frontend hoặc data trong phạm vi intent đã duyệt.
...
Gắn ownership dữ liệu, API/event, ranh giới tin cậy và ceiling ghi source thực tế vào intent. Chọn đúng nhánh backend/frontend/data cần thiết, không tự plan tất cả. Plan song song cần ownership node/resource mutable tách biệt. Review chứng minh tính nhất quán/coverage thiết kế, không chứng minh hành vi đã code.
