---
name: starci-frontend-behavior-audit
description: "Prove the business-visible outcome and side effects of selected UAT cases through read-only verification. Reject fixture finalization or any post-journey mutation that could manufacture success."
---

# starci-frontend-behavior-audit

Prove the business-visible outcome and side effects of selected UAT cases through read-only verification. Reject fixture finalization or any post-journey mutation that could manufacture success.
