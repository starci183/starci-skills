...
1. Validate fresh business authority, approved UX flow, approved interaction-container plan, and local analysis.
...
| --- | --- | --- |
| `generate` | business outcome, approved UX/container refs, current-experience evidence, direction knowledge | raw repository, UX redesign, API/business mutation, implementation context |
