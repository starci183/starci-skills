...
description: "Implement one approved and frozen frontend source inside its exact source boundary. Do not redesign surfaces, navigation, decoration, state, or responsive behavior."
---

# starci-frontend-implementation

Implement one approved and frozen frontend source inside its exact source boundary. Do not redesign surfaces, navigation, decoration, state, or responsive behavior.
