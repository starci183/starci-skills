---
name: starci-frontend-flow-audit
description: "Compile one feature into the smallest complete product-decision flow set, then one approved flow graph into a separate canonical happy case, material unhappy representatives, lower-level component delegations, fixture needs, and a declared sequential execution order. Do not issue a product verdict or repair source."
---

# starci-frontend-flow-audit

Compile one feature into the smallest complete product-decision flow set, then one approved flow graph into a separate canonical happy case, material unhappy representatives, lower-level component delegations, fixture needs, and a declared sequential execution order. Do not issue a product verdict or repair source.
