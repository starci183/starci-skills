---
name: starci-frontend-ui-audit
description: "Audit browser-observable composition, hierarchy, data presentation, render states, responsive behavior, overflow, accessibility, and Grammar fidelity. Emit SUSPENSE only for a finite unresolved UI authority question."
---

# starci-frontend-ui-audit

Audit browser-observable composition, hierarchy, data presentation, render states, responsive behavior, overflow, accessibility, and Grammar fidelity. Emit SUSPENSE only for a finite unresolved UI authority question.
