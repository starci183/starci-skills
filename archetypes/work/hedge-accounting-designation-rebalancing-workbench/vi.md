...
|---|---|---|
| [IFRS 9 Financial Instruments](https://www.ifrs.org/issued-standards/list-of-standards/ifrs-9-financial-instruments/) | Hedge-accounting policy, instrument recognition, and version context. | Không chứng minh product truth, exact geometry, breakpoint, component hoặc visual treatment. |
