...
|---|---|---|
| [CMS End-Stage Renal Disease facilities requirements](https://www.cms.gov/medicare/health-safety-standards/conditions-coverage-participation/end-stage-renal-disease-facilities) | Supports task-domain workflow and evidence obligations. | Does not prove product truth, exact geometry, breakpoints, components, or visual direction. |
