...
|---|---|---|
| [IFRS Foundation — IFRS 15](https://www.ifrs.org/issued-standards/list-of-standards/ifrs-15-revenue-from-contracts-with-customers/) | Contract, performance obligation, transaction price, allocation, and recognition principles. | Không chọn archetype, không định nghĩa product truth và không cho phép copy geometry. |
