...
|---|---|---|
| [SLAS — Microplate Standards](https://www.slas.org/resources/standards/ansi-slas-microplate-standards/) | Hỗ trợ well geometry and plate interoperability. | Không chọn archetype này, không định nghĩa product truth và không cấp quyền copy geometry. |
