...
|---|---|---|
| [ISAC — Data Standards](https://isac-net.org/data-standards/) | Hỗ trợ gating exchange, populations, compensation, and reproducibility. | Không chọn archetype này, không định nghĩa product truth và không cấp quyền copy geometry. |
