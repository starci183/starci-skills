...
SOURCE_ROOT = SKILLS_ROOT.parent if SKILLS_ROOT.name == ".claude" else SKILLS_ROOT
RUNTIME_ROOT = SKILLS_ROOT / "runtime" / "knowledge-runtime"
...
def parser() -> argparse.ArgumentParser:
    root = argparse.ArgumentParser(
        description="Build and query the embedded Qdrant Edge operator-knowledge index without a network service."
    )
    ...
    query = commands.add_parser("query", help="Return one compact typed operator-knowledge packet")
