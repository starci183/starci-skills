...
const TEXT = {
  en: {
    ...
    credential: 'This question asks for credentials, so it is not sent as a public link. Answer it on the machine:',
    localOnly: 'No public tunnel is configured; this link opens only on the machine:',
  ...
  vi: {
    ...
    credential: 'Câu hỏi này cần thông tin bí mật nên không gửi link công khai. Hãy trả lời trên máy:',
    localOnly: 'Chưa cấu hình tunnel công khai; link này chỉ mở được trên máy:',
