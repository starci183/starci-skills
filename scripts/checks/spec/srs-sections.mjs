...
import {normalizePolicyOptions} from './policy-options.mjs';

export const SRS_AGGREGATE_SCHEMA='starci/srs-aggregate@1';
export const SRS_SECTION_CONTRACT=parseYaml(fs.readFileSync(path.join(skillRoot,'modules','schemas','spec','srs-sections.schema.yaml'),'utf8'));
