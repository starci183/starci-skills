...
End-to-end proof exercises the connected application boundary with real routing, serialization, authentication policy, persistence behavior, and reversible test data. It uses the approved journey and seeded state contract; it does not invent a second test-only business flow.
