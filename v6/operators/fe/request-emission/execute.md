...
8. Run `node validate-output.mjs <output.json>` before emission. Otherwise return ready for implementation. This operator performs no product-source write.

The operator stops on invalid evidence, unstable IDs, path escape, collision, source-boundary mismatch or incomplete persistence.
