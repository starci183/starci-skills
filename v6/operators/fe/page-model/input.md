...
This operator starts after creative checkpoint one. It makes the selected flow structurally explicit; it does not reopen flow choice and does not create a layout direction.
