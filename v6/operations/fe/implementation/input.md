...
This operation receives one approved layout direction, its exact source boundary and the resolved source-fit plan. It writes product source; it does not reopen direction generation.
